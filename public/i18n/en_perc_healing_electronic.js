...
const EN_INST_PERC_HEALING_ELECTRONIC = {
  ...
  drum_set: {
    ...
    variants: {
      edrum: { label: "Electronic drums", note: "Practice in headphones — the standard answer for apartment self-study. About $270-$680. Kick pedal vibration still travels downstairs, so add an isolation mat ($15-$70)" },
      pad: { label: "Practice pad", note: "$15-$35. A pad alone covers 90% of stick control and rudiments. The answer for days you can't get to a studio" },
    },
  },
  ...
  crystal_bowl: {
    ...
    caveats: [
      "Doing it properly (a seven-chakra set) runs from the high $680 range into several million — start with one bowl and add as you go",
...
const EN_GUIDE_PERC_HEALING_ELECTRONIC = {
  ...
  drum_set: {
    how: "Oddly enough, the standard way to start drums is without a drum kit. $15 for sticks plus $20 for a practice pad and you're open for business! Learn basic strokes and rudiments (doubles, paradiddles) on the pad, then book an hourly rehearsal studio ($5-$5 an hour) once or twice a week to sit behind a real kit — that's the standard route in Korea. Make friends with the metronome on day one. On drums, a rock-steady 8-beat is 90% of the skill, not flashy fills.",
    ...
    buy: "The starter three-pack: sticks (5A size, $5-$15) + practice pad ($15-$35) + metronome (free app). If you want a kit at home, that means electronic drums, and entry models from Alesis, Yamaha and Roland run $270-$680. Even electronic kits send kick pedal vibration straight downstairs, so an isolation mat ($15-$70) is a must! Impulse-buying an acoustic kit is the classic landmine — secure a place to put it and a place to play it first.",
  ...
  finger_drum: {
    ...
    buy: "Yamaha's FGDP series is the standard here. The FGDP-30 (the standard model, high $140s to $210s) has speaker and batteries built in, so extra spending is zero! The higher FGDP-50 (around $270) adds pads and editing features. Prices swing with the exchange rate, so check before you buy. The landmine is accidentally buying a plain 'MIDI pad controller' — the FGDP type is what makes sound on its own with no computer.",
  ...
  djembe: {
    ...
    buy: "Small synthetic-head drums run $35-$100; full-size solid wood with natural skin is $140-$410. Percussion specialty shops and world-instrument dealers carry them. The landmine is the decorative souvenir djembe — thin skin and purely ornamental rope means no sound. A synthetic head like Remo is easier to maintain at the start.",
  ...
  bongo: {
    ...
    buy: "Entry models $35-$100 LP and Meinl brand tier $140-$270. They're the only Latin drum that fits in a backpack, which makes them a great travel companion. The landmine is the toy-grade pair with no tuning hardware — check that tuning lugs are there.",
  ...
  darbuka: {
    ...
    buy: "A Turkish aluminum starter runs $35-$100 — Korean stock is thin, so ordering direct from Turkish sellers is the common route. Egyptian and mosaic-inlaid upper models are $140-$340. The landmine is the ceramic souvenir darbuka — pretty, but it breaks and the sound is dull. A synthetic head on a metal shell is the easy-care standard.",
  ...
  frame_drum: {
    ...
    buy: "A Remo synthetic-head starter at $35-$100 is easy to maintain and perfectly good. Handmade natural-skin and tunable drums run $140-$410 mostly ordered from abroad. The landmine is a wall-decoration drum — if you want sound, pick a playing brand like Remo. Natural skin is sensitive to humidity, so beginners should start synthetic.",
  ...
  pandeiro: {
    ...
    buy: "Entry models $35-$100; Brazilian brands (Contemporanea and others) come to $140-$270 ordered from abroad. The landmine is a plain tambourine sold as a pandeiro — tuning lugs and dry-sounding jingles are what make it a pandeiro. A nylon head is easier for beginners to maintain.",
  ...
  bodhran: {
    ...
    buy: "Entry drums $70-$140 — Korean stock is thin, so ordering direct from an Irish workshop (McNeela and others) is the standard route. Tunable handmade drums are $210-$480. The landmine is the painted decorative bodhran from a souvenir shop — it bounces brightly and has no depth. Look at whether it's tunable and at the quality of the skin.",
  ...
  janggu: {
    ...
    buy: "Practice drums $100-$210; performance-grade whole-hide drums $340 and up — any gugak (traditional music) shop will have them, and plenty are online. Many classes lend you an instrument, so starting with your body and buying later is a smart move. The landmine is the mini souvenir janggu — that's interior decor.",
  ...
  tibetan_bowl: {
    ...
    buy: "The key distinction: machine-formed (smooth, even tone, $20-$70) versus Nepali hand-hammered (hammer marks, rich overtones, $70-$210). If you want one bowl for yourself, a handmade medium (15–20cm across) satisfies most people. The landmine is mystical marketing premiums like 'full moon bowls' and 'planetary frequencies' — listen on video and choose with your ears.",
  ...
  crystal_bowl: {
    ...
    buy: "A single frosted 8–10 inch bowl runs $170-$180 in Korea. A proper seven-chakra set is high $680 to several million, so yoga studios and meditation groups genuinely do split the cost as a group purchase. The landmine is shipping damage — check whether a carrying case is included and what the breakage policy is. The real running cost of this instrument is breakage.",
  ...
  koshi_chime: {
    ...
    buy: "Genuine Koshi chimes are $55-$80 each — that price is because they're handmade in a workshop in the French Pyrenees. Similar wind chimes start from $15-$35 but the tuning precision is different. The landmine is cheap 'Koshi style' copies — buy from an authorized importer and check for the engraved element name. Buying two and combining the chords is the well-known shortcut.",
  ...
  rainstick: {
    ...
    buy: "Small ones $5-$20 large or handmade (cactus wood) $25-$40. The longer it is, the longer the rain falls. There isn't really a landmine, though ultra-cheap ones with sloppy seams can leak beads, so a glance at the reviews is plenty.",
  ...
  ocean_drum: {
    ...
    buy: "Small ones $20-$40; genuine Remo and larger sizes $70-$100. The Remo ocean drum is effectively the standard, and the version with the fish design is popular as a gift for kids. The landmine is a cheap one whose beads rattle — if you hear beads rolling instead of waves, it failed.",
  ...
  tuning_fork: {
    ...
    buy: "Single forks $15-$40 (a 128Hz weighted one is the standard entry), frequency sets $70-$210. The landmines run both ways: ultra-cheap forks whose poor aluminum lets the vibration die immediately, and expensive sets sold on mystical claims. Remember it isn't a medical device and it stays a lovely tool.",
  ...
  launchpad: {
    ...
    buy: "The Novation Launchpad Mini MK3 at around $90 is the entry standard, Launchpad X about $170 Pro MK3 in the $270s. The landmine is assuming music comes out once you buy the pad — a reasonably specced computer is a hard prerequisite, and a full Ableton license (several hundred thousand won) waits down the road. The used market is active, so testing the water with a Mini and moving up is the smart play.",
  ...
  theremin: {
    ...
    buy: "The Moog Theremini (pitch correction included, so beginner-friendly) is $270-$340; the classic Moog Etherwave runs $480-$620 ordered from abroad, plus amp and stand. The landmine is a single-antenna toy theremin with no volume control — novel, but you can't practice on it. Checking the communities (overseas forums like Theremin World) is recommended.",
  ...
  jaw_harp: {
    ...
    buy: "A Vietnamese dan moi at $5-$20 is the value entry (it rests against the lips, so it's gentler on your teeth); a Yakut handmade khomus is $35-$100 ordered from abroad. The landmine is the soft cheap souvenir-shop kind — a dull reed won't split the overtones. If your teeth are weak or you're in braces, skip this one!",
  ...
  kazoo: {
    ...
    buy: "Plastic $5-$5 metal $5-$15 — the cheapest throne in all of instruments. There's no landmine as such, but the membrane is a consumable, so a few hundred won of spares is reassuring. Metal is half a class above in both sound and durability.",
  ...
  glass_harp: {
    ...
    buy: "Start at $5 with the glasses in your kitchen, then if you get serious, collect thin crystal glasses ($5-$20 each) by pitch. Thinner glass sings more easily, so cheap thin glasses from somewhere like IKEA make good experimental material. The landmine is thick tumblers — rub them all you like and they stay silent. A performance table to hold the glasses is DIY territory.",
  ...
  musical_saw: {
    ...
    buy: "You can try it with a flexible hardware-store saw ($5-$15), but the range is narrow. Serious mode means a dedicated musical saw (Mussehl & Westphal and others) ordered from abroad at $70-$210 plus a cello bow at $35-$100. The landmine is cutting your hand on the teeth — not a joke, it's a real saw, so taping the toothed edge and carrying it in a cover are essential.",
  ...
  hand_percussion: {
    ...
    buy: "Egg shakers a few thousand won, tambourines $5-$35 and even collecting the whole LP and Meinl small-percussion range stays under $70 — the small-joys corner of instrument shopping. The landmine is the jingle sound on a Daiso-grade tambourine (Daiso is Korea's discount variety chain): a rattle instead of a shimmer. For playing with others, branded props have a completely different density of sound.",
