...
const EN_INST_WOODWIND_FOLK = {
  ...
  tin_whistle: {
    ...
    caveats: [
      "At around $5 the risk isn't that it's cheap - it's that it looks so easy you quietly stop picking it up",
...
const EN_GUIDE_WOODWIND_FOLK = {
  ...
  low_whistle: {
    ...
    buy: "A Dixon polymer low D at around $70-$140 is the universal starter. Mid-range means Howard, Kerry and friends at $140-$270. Nearly all of it is direct import or a buying agent, so trying one in a Korean shop is the catch - if your hands are small, checking hole spacing on the spec sheet before you buy is a required ritual. The landmine is a no-name ultra-cheap aluminium tube.",
  ...
  ocarina: {
    ...
    buy: "A domestic Noble (Korea's biggest ocarina maker) ceramic 12-hole at $15-$35 is the standard entry, with Korean after-sales support to keep your mind at ease. Plastic goes under $5 but strictly as a taster. The landmine is the souvenir-shop ocarina - the bird shape is adorable, the tuning is feral.",
  ...
  pan_flute: {
    ...
    buy: "A proper curved Romanian 22-pipe runs $100-$270. Practice models exist around $35 but cheap straight-rank ones are a tuning lottery, so this is the instrument where saving money most easily costs you. Check Korean pan flute specialty shops and club group-buys.",
  ...
  quena: {
    ...
    buy: "Korean distribution is rare, so figure on direct import or a handmade workshop: bamboo starters $20-$50 playing instruments around $70. The landmine is the tourist-souvenir quena - excellent as decor, silent as an instrument. Checking workshop reviews in Andean music communities before ordering is the safe move.",
  ...
  shakuhachi: {
    ...
    buy: "The plastic starter 'Yuu' at around $70 by direct import has long been the standard (there's talk of it being discontinued, so stock may vary - check when you buy). Handmade bamboo is another world entirely, from hundreds of thousands into the millions of won, and can wait until you have a sound. The landmine is the cheap decorative bamboo shakuhachi - it was never built to be played.",
  ...
  sogeum: {
    ...
    buy: "At a gugak instrument shop: plastic starters around $20 bamboo practice instruments $70-$140. Clearing the sound barrier on plastic and then upgrading to bamboo is the economical two-step. No particular landmine, but it's a high instrument, so 'where will I practise' is a hidden condition of purchase.",
  ...
  daegeum: {
    ...
    buy: "A bamboo sanjo daegeum for practice at $100-$270 from a gugak shop is the realistic start. Plastic starters exist ($20-$35) but can't teach you the membrane's resonance, so treat them as sound-barrier tools only. For reference, at the far end of this world, handmade daegeum from ssanggoljuk (rare double-grooved bamboo) wait at several million won - a world you don't need to know about yet. The landmine is buying online without checking hand size: the holes are widely spaced, so try one in person.",
  ...
  piri: {
    ...
    buy: "A body-plus-reed set at a gugak shop runs $35-$140. Reeds are consumables, so having several from the start is essential (a few thousand to tens of thousands of won each). The landmine is neglecting reed condition - the reed is the sound, and if you can't enjoy caring for it, this romance ends early.",
  ...
  taepyeongso: {
    ...
    buy: "A beginner practice instrument at a gugak shop runs $70-$210 with reeds as separate consumables. The biggest landmine isn't the instrument, it's buying one before you have anywhere to play - blow this at home and your relationship with the neighbors goes solo first.",
  ...
  bansuri: {
    ...
    buy: "Direct from Indian workshops, $20-$100. Bamboo is cheap to make, but the whole game is picking a well-tuned example, so it's safest to buy a workshop vetted and recommended in Indian music communities. The landmine is the souvenir bansuri - pretty, and not in tune.",
  ...
  dizi: {
    ...
    buy: "Ordering from AliExpress is effectively the standard route - $15-$35 for practice, $35-$100 for something genuinely playable, which is top-tier value in this batch. When you order, be sure to add dimo and glue to the cart. The landmines are buying the flute without membrane and wondering why it sounds wrong, and decorative carved dizi.",
  ...
  xiao: {
    ...
    buy: "Via AliExpress: $20-$55 for practice, around $70-$140 for playable bamboo. For beginners the 8-hole layout with comfortable spacing is the pick (traditional 6-hole asks for a wider stretch). The landmine is, again, the decorative bamboo tube - check the reviews to confirm it actually sounds.",
  ...
  hulusi: {
    ...
    buy: "$15-$35 on AliExpress gets a perfectly usable C starter. The landmine is the rock-bottom no-brand: if the built-in reed is out of tune there's nothing you can do about it, so pick a mid-priced listing from a seller with lots of reviews.",
  ...
  highland_bagpipe: {
    ...
    buy: "To start, a practice chanter at $55-$140 is all you need (a Scottish brand like McCallum, ordered direct, is a safe bet). The full set is a year away - and even then, cheap Pakistani sets ($210-$410) are a famous minefield of unplayable instruments, so order a proper set ($1,050-$2,750 and up) with advice from someone senior in your band.",
  ...
  uilleann_pipes: {
    ...
    buy: "Honestly: a practice set runs $890-$2,400, direct from an overseas maker, with waiting lists of months to years as standard (longer at famous workshops). Half sets and full sets are a distant future of several million to ten million won and up. The landmine is clear - cheap Pakistani sets are frequently unplayable and strongly discouraged, so choose a maker on the recommendation of NPU or overseas piper communities.",
  ...
  galician_gaita: {
    ...
    buy: "With effectively no Korean distribution, assume a direct order from a Galician workshop - a student set runs $550-$1,700 (budget generously for exchange rates and duties). Korean information on makers barely exists, so check recent reviews in overseas gaita communities before proceeding. The landmines are no-name cheap sets, and the genre mix-up of 'it's Spanish so it must be flamenco' (it's Celtic).",
  ...
  suona: {
    ...
    buy: "AliExpress direct order is the standard route - a student set (body, bell and a few reeds) runs $20-$55 and a decent playable rosewood one $70-$100. Adding a stack of spare shaozi (reeds) to the order is a required ritual - they're consumables and you can't restock them in Korea. The landmines are decorative souvenir suonas, and buying before you've solved the practice-space problem - the first thing to ring out will be your relationship with the neighbors.",
  ...
  xun: {
    ...
    buy: "By AliExpress direct order, a beginner 10-hole (pen-grip style) runs $15-$35; master-made ceramic pieces start above $70. For starting out, a medium-sized (plum-to-fist) 10-hole with gentle resistance is the recommendation. The landmine is the tourist-souvenir xun - wonderful as decor, museum-grade as a tuned instrument. And it's ceramic: drop it and it reverts to its pre-excavation state.",
