...
const EN_INST_KEYBOARD_FREEREED = {
  ...
  piano_accordion: {
    ...
    variants: {
      digital_acc: { label: "Digital accordion", note: "Roland's FR series. Headphone practice is possible, but the price (from about ₩2M) is no joke." }
    }
  },
...
const EN_GUIDE_KEYBOARD_FREEREED = {
  ...
  piano: {
    ...
    buy: "For beginners an 88-key hammer-action digital piano is the right answer. Yamaha P-145, Roland FP-10 and Kawai ES120 are the proven three, at roughly ₩600,000-1M. The landmine is a 61-key light keyboard that looks like an 88. If the keys feel like sponge, your fingers will betray you at a real piano later.",
  ...
  pipe_organ: {
    ...
    buy: "A real pipe organ is a piece of architecture worth hundreds of millions of won, not a personal purchase. For home practice the standard is a three-manual digital classical organ with a pedalboard, from Johannus or Viscount (from about ₩5M). The landmine is buying a home electronic organ with no pedals just because it says 'organ.' Without pedals you cannot practice organ.",
  ...
  hammond_organ: {
    ...
    buy: "Start on a clonewheel, no exceptions. A used Hammond SK series or Nord Electro runs ₩800,000-2.5M, and the Crumar Mojo is a fine choice too. The landmine is romance: making a vintage B3 your first instrument. That 150kg cabinet breaks your wallet and your back at the same time.",
  ...
  clavichord: {
    ...
    buy: "Essentially nothing circulates in Korea, so importing from a workshop abroad is standard. Kits and used instruments run ₩3M-8M; finished new ones start around ₩10M. Harpsichord workshops like Zuckermann make clavichord kits too. The landmine is hearing 'quiet keyboard' and expecting a digital piano substitute. This is no substitute, it is a completely different and very sensitive creature.",
  ...
  toy_piano: {
    ...
    buy: "Toy and used models in Korea get you started for ₩30,000-100,000. The one treated as a performance instrument is Schoenhut, ₩150,000-300,000 imported, and there are digital variants like the Korg tinyPIANO. The landmine is a used one with missing keys or rusted metal rods; since it cannot be tuned, hardware condition is everything.",
  ...
  synthesizer: {
    ...
    buy: "A Korg Volca (around ₩200,000) or an Arturia MicroFreak (around ₩400,000) is the standard entry, and if you are saving money, a MIDI keyboard under ₩100,000 plus free plugins is excellent too. The landmine is gear acquisition syndrome. Buy your second synth after you finish one track on the first.",
  ...
  keytar: {
    ...
    buy: "A used Alesis Vortex runs around ₩400,000; to do it properly, a new Roland AX-Edge is ₩1.3M-1.5M. The landmine is buying a MIDI-controller model without realizing it has no sound engine. Always confirm whether it makes sound on its own.",
  ...
  melodica: {
    ...
    buy: "A Suzuki M-37C or a Yamaha Pianica P-37D, ₩30,000-150,000, is a keep-forever purchase. If you want the jazz and dub mood, Hohner is good too. The landmine is a ₩10,000 no-name toy; if the pitch is off, breath practice itself becomes meaningless.",
  ...
  piano_accordion: {
    ...
    buy: "For a first instrument, a used box of around 72 basses. Chinese-made new ones (Parrocel and the like) run ₩600,000-1.2M; used Italian or German ones (Weltmeister and friends) start at ₩1.5M. The landmine is a ₩30,000 glittery accordion - that is decor, not an instrument. Antique boxes with unknown reed condition are a repair-bill bomb, so borrow an experienced eye from an accordion club when you go looking.",
  ...
  bayan: {
    ...
    buy: "Almost nothing circulates in Korea, so importing from Russia or Europe is standard. A new student instrument (Tula and the like) is ₩1.5M-4M; used is a matter of luck. Concert grade (Jupiter) runs tens of millions, so do not even look. The landmine is buying a C-system chromatic thinking it is a bayan - the layout is mirrored and every book will be wrong. Always get a listing verified in an accordion community first.",
  ...
  cba_c_system: {
    ...
    buy: "Korean shops rarely carry them, so it means importing new or used from Europe. Chinese-made new ones start at ₩1.2M, used Italian or French ones at ₩2M. The landmine is buying without confirming the system - B-system (bayan) layouts are mirrored, so always check the first three rows in the listing photos. Instruments are scarce, so up-to-date listings from accordion communities get you halfway there.",
  ...
  diatonic_button_accordion: {
    ...
    buy: "Before buying, decide your target genre's standard key. Irish means B/C, norteno means GCF. That is nearly the whole story of buying this instrument. Chinese-made starters run from ₩400,000; Hohner (Corona and others) is ₩1M-1.8M imported. The landmine is buying without knowing the key - wrong tuning and you are playing music from another country all by yourself at a session.",
  ...
  bandoneon: {
    ...
    buy: "Finding an instrument is harder than learning it. A good used one (the legendary Doble A, say) is scarce worldwide at ₩6M-10M, and importing used from Argentina or Europe plus repairs (effectively mandatory) is the real route. New workshop builds start at ₩9M. The biggest landmine is a ₩300,000 'bandoneon-shaped accordion' - the layout and the sound are entirely different objects. Ask a Korean bandoneon or tango community to appraise any listing first.",
  ...
  diatonic_harmonica: {
    ...
    buy: "A Hohner Special 20 in C, ₩40,000-60,000, is the globally recognized starter. Suzuki Manji and Lee Oskar are equally right answers. The landmine is a ₩10,000 cheapie; the reeds will not bend, which only breeds the unfair suspicion that you have no talent. One genuine harp around ₩50,000 is plenty.",
  ...
  chromatic_harmonica: {
    ...
    buy: "An Easttop starter at ₩80,000-150,000 is the value gateway; to do it properly, a Hohner Chromonica 270 or a Suzuki SCX at ₩200,000-400,000 is standard. Two landmines: buying this when blues bending is the goal (that is diatonic territory), and used instruments with unknown valve condition (valves are sensitive to saliva and temperature).",
  ...
  tremolo_harmonica: {
    ...
    buy: "A 21-hole tremolo from Miwha, Tombo or Suzuki at ₩20,000-50,000 is the standard class instrument. Once you need semitones, holding a C and a C# stacked is the norm, so buying a set from the start is fine. It is a kind market with almost no landmines; just avoid unbranded souvenir-shop harmonicas.",
  ...
  saenghwang: {
    ...
    buy: "Imported 17-pipe instruments carried by gugak-sa (traditional instrument shops) run ₩600,000-2M. The market is small, so visiting a shop for advice beats hunting the lowest online price - tuning condition varies wildly at the same price. The landmine is importing a Chinese sheng from an overseas shop. They are sibling instruments, but the tuning systems differ and almost nowhere in Korea can tune or repair one, so aftercare hits a wall.",
  ...
  sheng: {
    ...
    buy: "A student 17-pipe from AliExpress or Taobao runs ₩250,000-600,000 (with margin for shipping and duties). The biggest trap isn't the price but the aftercare - almost nowhere in Korea can tune or repair a sheng, so if yours arrives out of tune, sending it back is the only remedy. Checking reviews and the return policy matters more than choosing the model, and if what you actually want to learn is the Korean saenghwang, a gugak-sa (traditional instrument shop) consultation is the right answer - it's a separate market.",
