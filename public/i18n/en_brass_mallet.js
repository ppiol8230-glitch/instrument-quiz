...
const EN_INST_BRASS_MALLET = {
  ...
  handpan: {
    ...
    caveats: [
      "Price trap: a cheap one bought on the logic that it is just for starting is either out of tune already or soon will be. With this instrument alone, accept that entry level means over ₩1,000,000",
...
const EN_GUIDE_BRASS_MALLET = {
  ...
  trumpet: {
    ...
    buy: "New, the Yamaha YTR-2330 (about ₩730,000-900,000) is the standard first horn. The ₩200,000-300,000 Chinese models do make sound, but sticky valves are a lottery. On a tight budget a used Yamaha beats a cheap new horn. Used checklist: (1) press all three valves and see if they spring back crisply, (2) does the tuning slide pull out smoothly (seized = deduct points), (3) dents in the bell or tubing. If you live in an apartment, budget about ₩300,000 for a Silent Brass rig (SB7 series, mute plus earphones) from day one - without it you simply cannot practice and the horn becomes furniture.",
  ...
  cornet: {
    ...
    buy: "Same price bracket as trumpet (₩300,000-900,000 to start), but fewer models reach Korea, so the choices are narrow. The Yamaha YCR line is the safe standard. The used checklist is identical - valve return, seized slides, dents. One catch: mutes are a different size, so make sure you buy cornet mutes!",
  ...
  flugelhorn: {
    ...
    buy: "The market is small, so a comparable horn costs more than a trumpet (₩600,000-1,500,000 to start). The smart move is a used Yamaha or Getzen rather than a cheap new one. Used checklist: valve return, plus a loose mouthpiece receiver (the flugelhorn's chronic ailment). Pitfall: mouthpiece shank sizes differ by brand (small morse, large morse and so on), so a random mouthpiece will not fit - check that it matches your horn!",
  ...
  sackbut: {
    ...
    buy: "Almost nothing reaches Korea, so importing is the default. Entry-level tenors from makers like Nartiss in Latvia start around ₩1,500,000; German and Swiss handmade instruments run over ₩5,000,000. Pitfall: some so-called baroque trombones are just modern horns with a small bell stuck on, so check the workshop's reputation with the early-music community before ordering. And confirm whether an A=415 tuning slide is included!",
  ...
  marimba: {
    how: "Good news first: zero worries about saliva, lips or calluses, and if you play piano the keyboard layout is identical, so you can teleport straight in! Bad news: the instrument is the size of a living room. So the standard route is to move your body instead of the instrument - practice on the marimbas at an academy, a rehearsal room or a university practice building, and at home use a rubber practice pad (₩20,000-50,000) for stick control and a used xylophone or a keyboard app for learning the note layout. Start with two-mallet scales; four-mallet grips (Stevens or Burton) come after the basics are solid!",
    ...
    buy: "Buying your own is a last resort (even a basic practice model starts around ₩1,500,000, and a concert rosewood one blows past ₩10,000,000). Realistic order: (1) sign up at a percussion academy or rehearsal room, instrument use included, (2) join a city orchestra or percussion ensemble and use their instrument, (3) own your mallets and nothing else (₩30,000-100,000 a pair, start with two pairs of medium hardness), (4) if you truly must buy, start with a used three-octave synthetic-bar model. Pitfall: buying a cheap children's xylophone toy as a marimba substitute - different range, different feel, different object.",
  ...
  xylo_glocken: {
    how: "The front door to the mallet world, and the only one in this family you can actually do at home! Buy a tabletop glockenspiel (₩50,000-150,000) and play straight from piano sheet music - that is your practice. Strike with a wrist snap so the mallet bounces off; press into the bar and the sound dies. The first technical task is layering alternating sticking (right-left-right-left) onto scales. Get hooked here and the door to marimba and orchestral percussion swings open.",
  ...
  timpani: {
    ...
    buy: "Set aside the idea of buying (₩3,000,000 for one drum, a performance set of four in the tens of millions, plus a spare room). Standard route: (1) group instruments at a city orchestra, school or church, (2) instruments in a percussion academy's lesson room, (3) own only mallets (timpani-specific, two or three pairs of different hardness) and a practice pad. Mallet landmine: never hit timpani with drumsticks or marimba mallets, which damages the heads - only timpani felt mallets!",
  ...
  steelpan: {
    ...
    buy: "Importing is the default (a tenor pan runs ₩1,000,000-2,500,000 plus shipping and duties). Checklist: (1) the maker's reputation as a tuner - with steelpan the builder is the tuner, (2) chrome plating for rust prevention, (3) whether a stand and sticks are included. Pitfall: cheap untuned pans and decorative souvenir pans are genuinely everywhere. Skip any listing that does not say concert pitch tuned. And know before buying that nobody in Korea can retune it for you every few years!",
  ...
  handpan: {
    ...
    buy: "This instrument's biggest hurdle is not playing, it is shopping! Iron rule: get a cheap one to start does not work here. The ₩600,000-1,000,000 mass-produced imports are a minefield of instruments already out of tune or soon to be. Verified route: import from a reputable maker like Yishama, Ayasa or Meraki, or buy a nitrided-steel 9-note sold in Korea (around ₩2,000,000). Budget from around ₩1.5M-2M for a proper one. Checklist: explicit nitrided or stainless material, a tuning video provided, and a D Kurd 9-note (the people's beginner scale) recommended. Care landmine: leaving it in a car in summer means tuning death.",
  ...
  tongue_drum: {
    ...
    buy: "Korean online marketplaces have decently tuned instruments from about ₩50,000 - one of the rare instruments where a cheap entry is genuinely fine! Recommended spec: 12 inches or more across, 13 notes or more (8 notes gets dull quickly), in D minor or C major. Checklist: does the set include mallets, a bag and a songbook. Pitfalls: not many, but if forced to name one, buying it expecting a handpan substitute. The class of resonance is different, so treat it as a healing accessory and handpan preparation.",
