...
const EN_GUIDE_HARP_LUTE = {
  ...
  concert_harp: {
    how: "Let's be honest — you can't just buy a concert harp and dabble. The standard route is: (1) spend a year or two on a lever harp building the basics (hand shape, arpeggios), then (2) move up to a pedal harp once you've decided this is a major or a serious hobby. If you want pedals from day one, look for a harp studio that keeps an instrument on site for lessons, or a rental program. You need time to befriend those foot pedals before a $13,700 piece of furniture moves in.",
  ...
  lyre_harp: {
    ...
    buy: "Korean online music shops (Angel Akgi and the like) and open marketplaces sell 16-string models for around $70 and 7-string ones for as little as $35. The only harp in the impulse-buy bracket. The landmine is the rock-bottom stuff at $15-$20 — loose tuning pins mean the notes won't survive a day, so check reviews specifically for whether tuning holds.",
  ...
  balalaika: {
    ...
    buy: "Barely sold in Korea. Importing from a Russian or Eastern European workshop, or an overseas marketplace, runs $140-$550 with wide quality variation. Biggest landmine: souvenir-shop decorative balalaikas flood the market — wall hangers with inaccurate frets that won't hold tune. Look for concert or prima labelling and reviews with actual playing footage before you buy.",
  ...
  cittern_modern: {
    ...
    buy: "Not sold in Korea. Importing from an Irish or British workshop, or an Eastern European production brand, runs $550-$2,050 and buying used abroad is the value route. The landmine is how blurry the border is with the bouzouki and octave mandolin — check a listing's scale length and tuning yourself, and pick a shorter scale if your hands are small. When in doubt, take the listing link to a Celtic instrument forum and ask.",
  ...
  renaissance_lute: {
    ...
    buy: "Not sold in Korea. The most proven entry is a student lute from The Early Music Shop (EMS) in the UK at £1,050–1,100, landing at $1,350-$1,700 after shipping and customs. Commissions from European or Chinese workshops run $2,050-$4,100 (Chinese makers vary in quality, so early-music forum reviews are mandatory reading). For used, the Lute Society marketplace is the value route. The landmines are lute-shaped ornaments, and used instruments kept at bad humidity — the body is thin, so always ask about crack history.",
  ...
  archlute: {
    ...
    buy: "No mass production. Assume a commission or an imported used instrument at roughly $3,400-$10,250, with a wait of several months to a year. Vet makers through recent reviews on international lute forums and early-music communities. The big pre-purchase question is always archlute or theorbo — the standard answer: archlute if you'll mostly play solo, theorbo if you'll mostly accompany ensembles.",
  ...
  theorbo: {
    ...
    buy: "Student instruments imported from the likes of EMS in the UK start around $2,750 though there are frequent warnings that cheap student models bought without an expert inspection carry major-repair risk — get a listing vetted by an early-music community first if you can. Commissioned concert-grade instruments run $4,800-$10,250 with a long wait. Used ones surface now and then on the international Lute Society marketplace, so set an alert. The biggest landmine isn't the instrument, it's buying without a transport plan — no car, serious rethink.",
  ...
  baroque_guitar: {
    ...
    buy: "Not sold in Korea. A commission from a European or Chinese workshop, or importing through EMS and similar, runs $1,350-$4,100 — simpler in construction than a lute, so slightly cheaper at the same grade. Chinese workshops are attractively priced but vary in quality, so verify with real purchase reports on early-music forums. The landmine is a half-measure like a modern classical guitar converted to five nylon courses — a Baroque guitar's body is built to a different design entirely.",
  ...
  renaissance_guitar: {
    ...
    buy: "Not sold in Korea. Assume a commission or import at $680-$2,050 — the cheapest way into the lute family. Check first whether early-music specialists like EMS carry one, and vet any workshop through forum reviews. Less a landmine than a forecast: the repertoire is limited, so before long you'll be curious about the Baroque guitar or the lute. That's normal growing pains.",
  ...
  mandolino: {
    ...
    buy: "Not sold in Korea. Assume a commission or import at $1,350-$4,100 — small doesn't mean cheap, since the build work is lute-grade. Research makers on international lute forums. The landmine is faking it by putting nylon strings on a modern mandolin — you end up with something wrong in both tone and tension design.",
  ...
  renaissance_cittern: {
    ...
    buy: "Not sold in Korea. Assume a commission or import at $1,050-$3,400 — simple construction makes it cheaper than a lute. Check whether EMS and similar shops carry one, and vet commissions through forum reviews. The landmine is confusing it with the modern cittern, a 1970s Irish instrument — same name, different tuning and different culture, so confirm the listing says renaissance cittern.",
  ...
  orpharion: {
    ...
    buy: "Zero mass production — a handful of workshops build to order, roughly $2,750-$8,200, with a long wait. Used ones appear maybe once every few years, so set an alert on the international Lute Society marketplace. Even working out which makers have ever built an orpharion is research in itself, so this is only for people who can enjoy the buying journey as a project of its own.",
  ...
  gallichon: {
    ...
    buy: "No mass production. Assume a commission or an imported used instrument at roughly $2,050-$6,850 — a tier below a Baroque lute in budget. Research makers on international lute forums. The landmine is the name: the mandora (gallichon) and the modern mandola are completely different instruments, so check spelling and period when searching or ordering.",
  ...
  psaltery: {
    ...
    buy: "Not sold in Korea. Importing from The Early Music Shop (EMS) or a European workshop runs $340-$1,350 — far more approachable than the rare lute-family instruments. Biggest landmine: the bowed psaltery is a 20th-century invention and effectively a different instrument. If a triangle turns up with a bow attached, you bought something else — confirm the listing says plucked psaltery.",
