...
const EN_INST_WOODWIND_WESTERN = {
  ...
  saxophone: {
    ...
    variants: {
      yds: { label: "Digital saxophone (Yamaha YDS)", note: "Real saxophone key layout, but you can practice in headphones. Around ₩800,000-900,000." },
      aerophone: { label: "Aerophone (Roland)", note: "A digital wind synth with sax-compatible fingering. Headphone practice, almost no saliva — it sidesteps the apartment problem entirely. Around ₩600,000-1,100,000." },
    },
  },
...
const EN_GUIDE_WOODWIND_WESTERN = {
  ...
  recorder: {
    ...
    buy: "Don't dismiss plastic — the Yamaha 300 series (YRA-302B/314 alto, about ₩30,000-60,000) and the upper Aulos models get used as practice horns by music majors. Want the taste of wood? Entry-level Moeck or Mollenhauer runs ₩100,000-400,000. There's exactly one landmine: trying to practice seriously on a ₩2,000 stationery-shop recorder — its intonation lives in another dimension.",
  ...
  flute: {
    ...
    buy: "The standard is the Yamaha YFL-222 (about ₩550,000-680,000 as of 2026) — the comfort food of beginner flutes. With more budget, step up to the YFL-312 (silver headjoint instead of nickel silver). Korean and Chinese makes around ₩300,000 will get you started, but key precision is a lottery, so try before you buy if you can. Landmine: those ₩100,000 'complete set' flutes online often have intonation on par with a toy kit.",
  ...
  piccolo: {
    ...
    buy: "The Yamaha YPC-32 (resin body) at around ₩1,000,000 is the standard entry choice. Piccolo has an unusually high 'you get what you pay for' index, and cheap imports can have dangerous intonation. Borrowing one from a wind band's stock is a very realistic way to start.",
  ...
  irish_flute: {
    ...
    buy: "A Dixon polymer flute in D, about ₩200,000-400,000 imported, is the entry standard. Wooden workshop instruments run ₩700,000 to ₩2M-plus, and since the holes are widely spaced, small-handed players must check the stretch before buying. Landmine: mystery bamboo tubes sold as 'Irish flutes' — lovely as decor.",
  ...
  clarinet: {
    ...
    buy: "The Yamaha YCL-255 (ABS resin, about ₩800,000-1,000,000) is the beginner staple. With more budget, the Buffet Crampon Prodige or E11 is the entry point into a legendary clarinet house. Reeds are consumables (₩10,000-20,000 a month), so build that into the budget from day one. Landmine: the ₩200,000 online 'complete sets' — bent keys and leaking pads are common.",
  ...
  oboe: {
    ...
    lesson: "Lessons essential — choosing reeds and building an embouchure alone is effectively impossible. And sourcing reeds is part of the lessons: rather than store-bought reeds (₩15,000-30,000 each, lasting 2-4 weeks), buying hand-scraped reeds from your teacher or a music major gives far more consistent quality. Without that connection, the reed lottery breaks your spirit before your lips.",
    buy: "Don't rush to buy — rental and used come first. When you do buy, a decent student model (Yamaha YOB-431 class) runs ₩3M-4M. Landmine: any oboe under ₩1M has disastrous intonation, and you end up in the 'it's not the oboe that's hard, it's this oboe' trap. Budget ₩30,000-60,000 a month for reeds as a fixed cost.",
  ...
  english_horn: {
    ...
    buy: "Student models start around ₩4M, so buying your own is a last resort. For amateurs, borrowing the orchestra's instrument or buying used is the realistic path. Dedicated reeds cost more than oboe reeds at ₩20,000-40,000 each — again, secure a supply from a music major. Landmine: 'I'll just stick an oboe reed in' — you won't, the specs are different.",
  ...
  bassoon: {
    ...
    lesson: "Lessons essential — anyone who cracked double-reed embouchure, reed maintenance and that unique fingering system alone exists only in legend. Part of the bassoon lesson package is that your teacher becomes your reed supply (scraping them personally or connecting you to a major). Reeds run ₩15,000-30,000 each and last 2-6 weeks.",
    buy: "New student models (Schreiber or Fox Student class) run ₩4M-8M, so buying comes later — renting from an orchestra's stock (a few tens of thousands of won a month) or going used is the proper entrance. Landmine: an imported ₩1M 'bassoon' is most likely something bassoon-shaped with different intonation and keywork. The finger stretch is the largest in the woodwinds, so trying one in person is mandatory too.",
  ...
  saxophone: {
    ...
    buy: "The standard is the Yamaha YAS-280 (alto, ₩1.2M-1.5M). On a tighter budget, Antigua or Korean brands at ₩400,000-800,000 are plenty to start. And now the great landmine: 'saxophones' online for ₩50,000-200,000 — those are saxophone-shaped objects. Bent keys and leaking pads make teachers sigh on sight. If you live in an apartment, seriously consider opening the headphone-practice route with a digital sax (Yamaha YDS, ₩800,000-900,000) or an Aerophone (Roland, ₩600,000-1,100,000).",
  ...
  traverso: {
    ...
    buy: "Korean shops don't carry them — we'll be honest about that. The entry standard is the Aulos plastic traverso (AF series, ₩250,000-450,000 imported), and yes, plastic is genuinely good enough for serious practice. Wooden instruments mean ordering from a European workshop (from ₩1.5M, with a wait). Used ones circulate in the early-music and recorder communities, so go say hello there first.",
  ...
  baroque_oboe: {
    ...
    buy: "Not available in Korea — a new instrument from a European workshop (Moeck and others) is ₩2M-5M plus a wait, and used circulation within the early-music world is the realistic path. Reeds cost ₩20,000-40,000 each imported, but making your own (tool kit extra) is the standard here. Landmine: mystery 'Baroque oboe' replicas on eBay — their intonation is neither Baroque nor modern but from a third world entirely.",
  ...
  dulcian: {
    ...
    buy: "Nothing sold in Korea — new from a European workshop (Wolf, Moore and the like) at ₩2.5M-7M plus a wait of months to years is the honest reality. Used circulation in the early-music world and workshop rentals are the practical entrances, so knock on the community's door first. Reeds are imported (₩20,000-40,000 each) or homemade. Less a landmine than a trap: 'a bassoon reed will do, right?' — similar, but there is a dedicated reed.",
  ...
  shawm: {
    ...
    buy: "Not available in Korea — a Susato plastic shawm at ₩300,000-500,000 imported is the entry standard, and wooden workshop instruments start above ₩1M with a wait. The big dedicated double reeds are imported too (₩20,000-30,000 each) or homemade. Landmine: souvenir-shop 'medieval pipes' — they make noise, but their intonation stayed behind in the Middle Ages.",
  ...
  crumhorn: {
    ...
    buy: "Not available in Korea — Susato plastic runs ₩400,000-600,000 imported, and wooden ones from Moeck and others start above ₩1M. The reed sits inside the cap and never touches your mouth, so it lasts a long time (₩20,000-40,000 per replacement). There aren't many landmines, but buying only a soprano leaves you with a 'buzzing kazoo solo', so plan for alto and tenor to join it.",
  ...
  cornetto: {
    ...
    buy: "Not available in Korea — resin beginner replicas run ₩400,000-700,000 imported, and the industry-standard Christopher Monk workshop resin/leather models are ₩1M-1.7M (imported from the UK). Handmade wooden ones run into the millions plus a wait. There are almost no consumables, so after the initial outlay it only costs you time. If your hands are small, starting on a small cornettino is an option.",
