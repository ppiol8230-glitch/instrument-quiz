...
const EN_INST_GUITAR_MANDOLIN = {
  ...
  acoustic_guitar: {
    ...
    variants: {
      silent_guitar: { label: "Silent guitar", note: "A frame guitar with no body. Practice at night through headphones. Yamaha SLG and similar, around $410-$680." }
    }
  },
  ...
  ukulele: {
    ...
    caveats: [
      ...
      "Toy-grade instruments (under $20) won't hold tuning and become the actual reason people quit"
    ]
  },
...
const EN_GUIDE_GUITAR_MANDOLIN = {
  ...
  classical_guitar: {
    ...
    buy: "$100-$340. The Yamaha C40 (around $70) is the world's unofficial standard starter; at $140-$270 solid-top options open up, like the Yamaha CG series or Cort's classical line. Landmine: the sub-$35 'guitar-shaped object' from a discount mart never holds pitch and will make you doubt your own ears. Grabbing a used Yamaha starter for half price on Danggeun Market (Korea's local secondhand app) is an excellent move too.",
  ...
  acoustic_guitar: {
    ...
    buy: "$140-$270 buys a first guitar you can keep for life. Korea is arguably the world's best country for beginner acoustics - domestic brands like Cort, Crafter and Gopherwood get reverse-imported by players abroad. Landmine: the $20-$35 mart guitar has an action so high it becomes a finger-endurance testing device. Picking up a used Cort starter for around $70 on Danggeun Market is a classic route.",
  ...
  electric_guitar: {
    ...
    buy: "Guitar $210-$340 plus something that makes sound $70-$210. The two beginner pillars are the Squier (Fender's sub-brand) Affinity series and the Yamaha Pacifica 112 - the official answer on beginner forums worldwide. Korea's own Cort is excellent too. Landmine: the 'guitar + amp + bag full package for $130' set is usually uniformly bad in every item. Squier and Pacifica listings are always on Danggeun Market, so used is strongly recommended.",
  ...
  bass_guitar: {
    ...
    buy: "Bass $170-$340 plus a headphone amp or interface around $70. The three proven starters are the Squier Affinity Jazz and Precision basses, the Yamaha TRBX series, and Korea's own Cort Action Bass. Landmine: mystery $35 basses very often have a warped neck. If your hands are small, definitely look up short-scale models.",
  ...
  ukulele: {
    ...
    buy: "$35-$100 is plenty. Locally, brands like Luau and Makana are proven for beginners and after-sales service is decent. On size, concert fits adult hands better than soprano (the smallest). Landmine: toy-grade instruments under $20 go out of tune every five minutes and become the actual reason people quit - dodge the cheapest-price temptation and this instrument is basically failure-proof.",
  ...
  lap_steel: {
    ...
    buy: "Instrument $140-$270 (SX, Recording King and friends, importing included) plus a bar and fingerpicks at $15-$20 plus a headphone amp, and you're done. It's the cheapest doorway into the whole steel-guitar world. Landmine: buy only the instrument with no amp and you get no sound (it's electric!). Local listings are scarce, so importing or setting alerts on used-gear sites is the way.",
  ...
  mandolin: {
    ...
    buy: "Budget A-style starters exist locally from under $140 and if you're serious, importing a Kentucky KM-150 or Eastman MD305 (both global beginner standards, $410-$550) is the recognized answer. Landmine: the temptation of the F-style scroll - same sound, tens of thousands of won extra for decoration, so A-style is the sensible entry. A $20 decorative mandolin is a prop, not an instrument.",
  ...
  mandobass: {
    ...
    buy: "$2,050-$6,850 (estimated from overseas vintage prices) - there's essentially no new market, so auctions, overseas used sales and custom builds are all there is. Landmine: the biggest cost isn't the instrument, it's international shipping (a wooden antique the size of a person...). If you seriously want one, joining a mandolin-orchestra community for information first is the only sensible route.",
  ...
  greek_bouzouki: {
    ...
    buy: "$270-$820 imported (Greek workshops or via Europe). The landmine here is obvious: the $140 sparkly bouzouki in a Greek tourist shop is a wall decoration, not an instrument. The flashier the mother-of-pearl inlay, the more suspicious you should be. For a playable instrument, order direct from a workshop or go through a trusted European dealer.",
  ...
  bandolim: {
    ...
    buy: "$270-$820 imported (via Brazil or elsewhere; the estimate is a wide range). Practical advice: start choro on a regular mandolin (a Kentucky or Eastman starter), then add a bandolim once you know you're serious - the two-stage strategy. Landmine: importing from Brazil has big shipping and customs variance, so listings routed through Europe or the US are often safer.",
