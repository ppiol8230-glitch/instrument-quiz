...
const EN_INST_BOWED = {
  ...
  violin: {
    ...
    variants: {
      silent_violin: { label: "Electric / Silent Violin", note: "An electric violin with no body, or just a skeleton frame. Practice through headphones — the apartment night problem solved outright. Fingering and bow feel are identical to acoustic, so switching costs you almost nothing. Yamaha and others, $270-$680." },
    },
  },
  ...
  cello: {
    ...
    variants: {
      electric_cello: { label: "Electric Cello", note: "A skeleton-bodied electric cello. Headphone practice fixes the apartment night problem, and the shrunken body makes carrying it far easier. Yamaha and others from around $680." },
    },
  },
  ...
  double_bass: {
    ...
    variants: {
      eub: { label: "EUB (Electric Upright Bass)", note: "A bodyless stick-style electric upright. Headphone practice plus a case the size of a ski bag solves both problems at once. From around $680. You do give up the acoustic resonance." },
    },
  },
...
const EN_GUIDE_BOWED = {
  ...
  violin: {
    ...
    buy: "The realistic starting line is a workshop-set-up instrument around $210 (roughly $140-$410 overall). In Korea, Shimro Master (the $210s), Stentor, Yamaha Braviol (V5S and friends) and Hyoman are the safe beginner brands. Rental ($15-$35 a month) is a fine choice too. But a $20 internet violin isn't an instrument, it's a violin-shaped noisemaker — it won't hold a tuning for one day.",
  ...
  cello: {
    ...
    buy: "A beginner outfit is $550-$1,350, on the pricier end for a string instrument, which is why many adults start with rental ($35-$100 a month). If you buy, get a workshop or luthier setup rather than the cheapest listing online. For reference, a set of strings alone is $100-$210 and the trade's old wisdom is that good strings on a cheap cello beats the other way around.",
  ...
  baroque_violin: {
    how: "The standard route is building your foundation on modern violin and then crossing over. The most realistic first step is the 'half entry': put a baroque bow ($210-$550) and gut strings on the modern violin you already own — that setup alone is plenty to start practicing baroque phrasing. Knock on the doors of Korea's early-music ensembles and university early-music programs first.",
    ...
    buy: "A dedicated student instrument runs $1,050-$3,100 ordered from overseas workshops. Rather than buying one right away, though, your wallet is safer if you start with the baroque bow plus gut strings and shop for an instrument once you're sure. Budget for the strings as well: $70-$140 a set with a 3–6 month lifespan, a whole kingdom of consumables. For sellers and makers, advice from the period-performance community is the best minesweeper there is.",
  ...
  baroque_cello: {
    how: "Learning modern cello first and crossing over is essentially the only standard route. Step one is the conversion entry: pull the endpin out of the cello you have and put on gut strings and a baroque bow ($340-$1,050) — start by practicing how it feels to grip the instrument with your calves. Ensemble work (continuo) is the day job, so finding a baroque ensemble in advance doubles the fun.",
  ...
  viola_damore: {
    ...
    buy: "There's essentially no domestic distribution, so custom orders or importing are the only routes, and you should budget widely: $2,050-$6,150. The very idea of a 'mass-market beginner model' barely exists here, so community advice before buying isn't optional, it's required. With 13–14 strings, put string costs and tuning labor into your budget and your schedule up front.",
  ...
  viola_da_gamba: {
    ...
    buy: "Imported from Chinese workshops (Lu-Mi and others), treble and tenor start around $1,700 and bass around $2,750 ($1,700-$4,100 overall). Domestic distribution is nearly nonexistent, so importing, custom orders and used finds through the early-music community are the real routes. Safest is to start on a society or club rental, settle on your size (treble/tenor/bass), then buy — a cheap 'viol' of unknown origin can cost more in setup than it saved you.",
  ...
  lirone: {
    ...
    buy: "No mass-market model exists; this is custom-order only — figure roughly $2,750-$8,200 based on gamba workshop quotes, though only an actual quote knows for sure. Community advice before buying is a must. With 9–16 strings, string costs and tuning time are constant, and an instrument that's a 'lirone' in name only is obviously a landmine.",
  ...
  rebec: {
    ...
    buy: "No domestic distribution, so the route is British early-music shops (Early Music Shop and the like) or European workshops; budget $480-$1,350 including shipping and duties. There's no standard spec, so it's safest to bring photos and specs to the early-music community before buying — the classic landmine is buying a decorative 'medieval-style' wall hanging and expecting to play it.",
