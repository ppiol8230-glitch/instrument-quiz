...
const INST_HARP_LUTE = [
...

  {
    ...
    family: "하프류",
    desc: "47현·7페달의 오케스트라 하프. 발로 페달을 밟아 반음을 만들고, 두 손 여덟 손가락(새끼 제외)으로 뜯어요. 하프의 최종 보스이자 가격의 최종 보스.",

    sound: {
      tone: ["영롱함", "웅장함", "화려함", "맑음"],
      toneDesc: "홀 전체를 감싸는 영롱한 글리산도와 깊은 저음. 작은 하프와는 울림의 스케일 자체가 달라요. 여운이 길어 한 음만 뜯어도 공간이 차요.",
      volume: 4,
      sustain: 5,
    },
    ...
    body: {
      saliva: 0,
      callus: 3,
      callusDesc: "거트/나일론 현을 손끝 살로 뜯어요. 초반 물집·껍질 벗겨짐은 통과의례, 이후 단단한 굳은살로 정착.",
      embouchure: 0,
      breath: 0,
      weight: 5,
      weightDesc: "36~40kg에 키 180cm급. 혼자 계단 이동 불가, 이사엔 전용 카트와 밴이 필요해요. 사실상 '집에 두는 가구'.",
      posture: "악기를 어깨에 기대어 앉는 자세 자체는 편하나, 장시간 연습 시 오른어깨·등 긴장. 페달 조작으로 발도 바빠요.",
      postureRisk: ["목어깨", "허리"],
    ...
    cost: {
      ...
      entryDesc: "입문용 스튜던트 페달 하프(살비·라이온앤힐리 등)가 2천만원대부터. 국내 공식 수입처(하프 갤러리 등) 존재. 최상위 모델은 3억 원을 넘어요. '입문'의 가격 게이트가 모든 악기 중 최고.",
    ...
    caveats: [
      "가격이 진짜 게이트예요 — 렌탈·중고 시장도 국내에선 얇아요",
      "운반이 삶의 조건을 바꿔요(차·엘리베이터·거치 공간)",
      "레슨은 서울·수도권 음대 라인 위주. 지방은 선생 찾기부터가 일",
      "예산이 안 되면 레버 하프로 시작하는 것이 표준 루트",
    ],
    funFacts: [
      "페달 7개가 각각 도~시 음을 담당해, 발로 조옮김을 하는 악기예요",
      "국내에 아시아 최초 공개된 라이온앤힐리 최상위 모델 가격은 3억 6천만원이었어요",
    ],
  },

  {
    ...
    body: {
      saliva: 0,
      callus: 3,
      callusDesc: "손끝 살로 뜯는 건 콘서트 하프와 동일. 초반 물집 구간을 지나야 해요.",
      embouchure: 0,
      breath: 0,
      weight: 3,
    ...
    practical: {
      portability: 3,
      noise: 3,
      apartmentOk: "낮 연습 무난. 콘서트 하프보다 한 단계 조용해요.",
      selfLearn: 3,
      lessonKR: 2,
      entryBarrier: 2,
      quickReward: 4,
    ...
    funFacts: [
      "아일랜드는 국장(국가 문장)이 하프인 세계 유일의 나라예요",
      "콘서트 하프 진학 여부와 무관하게, 켈틱 씬에서는 레버 하프가 '진짜' 전통 악기예요",
    ],
  },

  {
    ...
    family: "하프류",
    desc: "7~16현의 무릎 위 소형 하프. 고대 그리스 리라의 후예로, 요즘은 힐링·명상용 악기로 국내 악기점에서도 쉽게 살 수 있어요.",

    sound: {
      tone: ["영롱함", "맑음", "소박함", "따뜻함"],
      toneDesc: "작고 여린 방울 같은 울림. 음량이 작아 밤에 이불 위에서 뜯어도 되는 수준. '연주'보다 '소리 자체를 즐기는' 악기에 가까워요.",
      volume: 2,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "현 장력이 약해 하프류 중 손끝 부담 최소. 그래도 첫 주엔 손끝이 얼얼해요.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "1~2kg. 가방에 넣어 다녀요.",
    ...
    caveats: [
      "온음계 조율에 현 수가 적어 칠 수 있는 곡의 폭이 좁아요 — 금방 천장에 닿으면 레버 하프로 갈아타게 됨",
      "레슨 문화가 사실상 없음(독학·유튜브 전제)",
      "초저가 제품은 조율이 잘 안 맞거나 금방 틀어지는 경우 있음",
    ],
    funFacts: [
      "발도르프 교육에서 아이들 정서 악기로 쓰이면서 '힐링 악기'로 재유행했어요",
    ],
  },

  {
    ...
    family: "하프류",
    desc: "현이 3열로 나란히 걸린 바로크 하프. 바깥 두 줄이 온음계, 가운데 줄이 반음계 — 레버도 페달도 없이 손가락을 열 사이로 찔러 넣어 반음을 뜯어요. 웨일스의 국민 악기이자 바로크 통주저음 악기.",

    sound: {
      tone: ["영롱함", "고풍스러운", "따뜻함", "신비"],
      toneDesc: "거트현 특유의 옛스럽고 둥근 울림. 모던 하프보다 음량은 작지만 배음이 복잡하게 얽혀 촛불 같은 질감이 나요.",
      volume: 3,
      sustain: 4,
    },
    ...
    cost: {
      ...
      entryDesc: "양산품이 없어요. 유럽 하프 공방 주문 제작·직구가 유일한 경로로, 사양·공방에 따라 가격 편차가 매우 커요(범위는 대략치). 대기 수개월~1년.",
    ...
    caveats: [
      ...
      "3열 조율만 한 시간 코스라는 농담이 있어요(현 90여 개)",
      "악기 확보 자체가 프로젝트(공방 리서치→주문→대기→직구 통관)",
    ],
    funFacts: [
      "몬테베르디의 오페라 '오르페오' 악보에 지정된 'arpa doppia'가 이 계열이에요",
      "웨일스에서는 아이스테드바드(전통 경연 축제)의 상징 악기예요",
    ],
  },

  {
    ...
    sound: {
      ...
      toneDesc: "종소리 같은 금속 배음이 몇 초씩 겹겹이 이어져요. 오르골과 벨 사이의 소리. 여운을 안 끊으면 음이 뒤엉키므로, 소리 내기보다 소리 끄기가 기술이에요.",
      volume: 3,
      sustain: 5,
    },
    ...
    body: {
      saliva: 0,
      callus: 1,
      callusDesc: "살 대신 손톱으로 뜯어 물집 부담은 적어요. 대신 손톱을 일정 길이·모양으로 기르고 관리하는 것이 연주 조건.",
      embouchure: 0,
      breath: 0,
      weight: 2,
    ...
    funFacts: [
      "중세 게일 사회에서 하피스트는 시인과 함께 최고 대우를 받는 직업이었어요",
      "기네스 맥주 로고의 하프가 바로 이 클라르사흐(브라이언 보루 하프)예요",
    ],
  },
...

  {
    ...
    body: {
      saliva: 0,
      callus: 1,
      callusDesc: "피크나 핑거픽으로 스트럼해 손끝 부담 거의 없음. 버튼 누르는 왼손도 편해요.",
      embouchure: 0,
      breath: 0,
      weight: 2,
    ...
    caveats: [
      "버튼에 있는 코드만 칠 수 있어요 — 재즈식 텐션 코드는 구조적으로 불가",
      "멜로디 주법(멜로디 피킹)도 있지만 상급 기술이고, 기본 정체성은 반주 악기",
      "36현 조율은 튜너 들고 15분 코스",
    ],
    funFacts: [
      "코드 운지를 익힐 필요가 없어 '첫날 반주 성공'이 실제로 가능한 몇 안 되는 현악기예요",
      "컨트리의 대모 메이벨 카터, 존 세바스찬 등이 무대 악기로 썼어요",
    ],
  },

  {
    ...
    family: "발현·포크",
    desc: "무릎 위에 눕혀 놓고 치는 3~4현 프렛 악기. 프렛이 온음계(도레미 배열)라 아무렇게나 짚어도 조 안의 음만 나요. 미국 애팔래치아 산악 지대의 홈메이드 포크 악기.",

    sound: {
      tone: ["소박함", "따뜻함", "콧소리", "나무 울림"],
      toneDesc: "드론 현이 계속 울리는 위로 멜로디가 얹히는, 백파이프를 닮은 소박한 울림. 화려하진 않지만 난롯가 같은 정감이 있어요.",
      volume: 2,
      sustain: 3,
    },
    ...
    body: {
      ...
      posture: "무릎 위에 눕혀 놓고 치는 자세라 목·어깨 부담이 사실상 0. 손목도 편해요.",
      postureRisk: [],
      handSize: "무관. 한 손가락 주법(노터 스틱)도 전통 주법이에요.",
    },

    cost: {
      entryKRW: [200000, 700000],
      entryDesc: "국내 판매 거의 없음. 미국 공방(맥스페이든 등)·아마존 직구 기준 $150~450 + 배송. 합판 입문기는 더 싸요.",
    ...
    funFacts: [
      "온음계 프렛 덕에 '틀린 음을 누르는 것 자체가 어려운' 악기로 불려요",
      "조니 미첼이 명반 'Blue'에서 기타 대신 덜시머로 여러 곡을 반주했어요",
    ],
  },

  {
    ...
    family: "발현·포크",
    desc: "삼각형 몸통의 러시아 3현 악기. 표준(프리마)은 E-E-A 조율로, 두 줄이 같은 음이라 손가락 하나로도 멜로디+드론이 돼요. 트레몰로와 손가락 스트럼이 시그니처.",

    sound: {
      tone: ["카랑카랑", "애수", "반짝임", "소박함"],
      toneDesc: "낭랑하게 튕기다가 트레몰로로 들어가면 애절해지는 이중적인 소리. 러시아 민요 특유의 웃다가 우는 정서를 그대로 담아요.",
      volume: 3,
      sustain: 1,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 1,
      weightDesc: "1~1.5kg. 삼각형이라 케이스는 좀 커요.",
    ...
    practical: {
      portability: 5,
      noise: 3,
      apartmentOk: "낮 연습 무난. 서스테인이 짧아 소리가 덜 퍼져요.",
      selfLearn: 3,
      lessonKR: 1,
      entryBarrier: 2,
      quickReward: 4,
    ...
    caveats: [
      ...
      "콘트라베이스 발랄라이카 같은 대형 편성은 국내에서 접할 기회가 없어요",
    ],
    funFacts: [
      "영화 '닥터 지바고'의 라라의 테마로 세계에 각인된 소리예요",
      "같은 음 두 줄 조율 덕에 첫날부터 그럴듯한 멜로디가 나요",
    ],
  },

  {
    ...
    aka: ["charango", "차랑고"],
    family: "발현·포크",
    desc: "안데스 고원의 10현(5코스) 초소형 발현악기. 우쿨렐레만 한 몸통에서 잘랑거리는 고음이 폭포처럼 쏟아져요. 전통적으로 아르마딜로 등딱지로 만들던 악기(현재는 나무).",
    ...
    body: {
      ...
      breath: 0,
      weight: 1,
      weightDesc: "0.5~1kg. 백팩에 들어가요.",
      posture: "품에 안는 자세. 부담 없음.",
      postureRisk: [],
      handSize: "스케일이 매우 짧아 손 작은 사람에게 최적. 손이 크면 오히려 프렛이 비좁아요.",
    },
    ...
    funFacts: [
      "우쿨렐레와 조율 골격이 비슷해 우쿨렐레 경험자는 첫 코드를 10분 만에 잡아요",
      "사이먼 앤 가펑클 'El Condor Pasa'의 원류가 이 악기의 동네예요",
    ],
  },

  {
    ...
    body: {
      saliva: 0,
      callus: 3,
      callusDesc: "쇠줄이라 우쿨렐레 감각으로 잡으면 손끝이 놀라요. 기타 수준의 물집 통과 필요.",
      embouchure: 0,
      breath: 0,
      weight: 1,
    ...
    funFacts: [
      "포르투갈 이민자들이 하와이로 가져간 이 악기 계열이 우쿨렐레가 됐어요",
      "삼바 학교 퍼레이드에서 수백 명의 타악기를 뚫고 들리는 유일한 발현악기예요",
    ],
  },

  {
    ...
    family: "발현·포크",
    desc: "5코스 10현의 모던 포크 악기. 1970년대 아이리시 리바이벌에서 만돌린족을 키워 만든 물건으로, 부주키와 형제간. 낮고 넓은 울림으로 멜로디와 반주를 오가요.",

    sound: {
      tone: ["반짝임", "나무 울림", "낮고 깊음", "몽환"],
      toneDesc: "더블 코스의 코러스가 만돌린보다 한 옥타브 아래서 넓게 퍼져요. 드론을 깔며 치면 켈틱 특유의 안개 낀 울림이 나요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      ...
      postureRisk: [],
      handSize: "스케일이 길어(50~55cm) 손이 작으면 부주키보다 짧은 스케일 모델을 고르는 게 좋아요.",
    },
    ...
    caveats: [
      ...
      "국내 인지도 0에 가까움 — 세션 나가면 '그게 뭐예요' 질문부터 받아요",
      "표준 조율이 여러 개(GDAEA, DGDAD 등)라 초반에 하나를 정해야 함",
    ],
    funFacts: [
      "이름은 르네상스 시턴에서 빌렸지만 실제로는 1970년대에 태어난 젊은 악기예요",
      "만돌린 경험자가 '더 낮고 더 넓은 소리'를 찾을 때의 정답 중 하나예요",
    ],
  },
...

  {
    ...
    family: "발현·류트족",
    desc: "6~8코스의 서양배 모양 발현악기. 16세기 유럽에서 '악기의 왕'이었고, 다울랜드의 노래와 독주가 이 악기의 심장이에요. 류트족 전체의 표준 입구.",

    sound: {
      tone: ["따뜻함", "부드러움", "애수", "나무 울림"],
      toneDesc: "거트(또는 나일거트) 현을 손끝 살로 뜯는, 촛불처럼 흔들리는 여린 소리. 크지 않지만 가까이서 들으면 숨소리까지 담기는 친밀함이 있어요.",
      volume: 2,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "장력이 낮고 손톱 없이 살로 뜯어 기타보다 손끝 부담 덜함. 대신 오른손 터치를 처음부터 다시 배워요.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "1kg 미만 — 겉보기와 달리 깃털처럼 가벼워요. 케이스가 몸통 모양이라 부피는 있음.",
    ...
    cost: {
      ...
      running: "나일거트 현값 + 습도 관리. 거트현 풀세트는 수십만원대라 대개 합성현으로 타요.",
    },
    practical: {
      portability: 4,
      noise: 2,
    ...
    caveats: [
      "'류트 연주자는 인생의 절반을 조율하며 보내고, 나머지 절반은 안 맞는 류트를 연주하며 보낸다'는 옛 농담이 있어요 — 복수 코스+거트계 현의 숙명",
      "악보가 오선보가 아닌 타블라추어(류트 전용 기보)라 별도 학습 필요(다행히 기타 타브보다 논리적)",
      "국내 레슨은 손에 꼽는 연주자 몇 명뿐 — 온라인 레슨·해외 자료 전제",
      "습도에 민감(얇은 몸통) — 겨울 가습 필수",
    ],
    funFacts: [
      "다울랜드의 'Flow My Tears'는 당대 유럽 전체의 히트곡이었어요",
      "엘리자베스 1세 시대 류트 명인의 연봉은 궁정 최고 수준이었어요",
      "스팅이 다울랜드 음반(Songs from the Labyrinth)을 내면서 대중에게 재소환됐어요",
    ],
  },

  {
    ...
    sound: {
      ...
      toneDesc: "개방 베이스 현들이 공명하며 만드는 그늘진 울림. 르네상스 류트보다 어둡고 사색적이며, 혼자 밤에 듣는 소리로는 발현악기 최고봉이라는 팬이 많아요.",
      volume: 2,
      sustain: 3,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 2,
      weightDesc: "1.5kg 안팎으로 가볍지만 13코스는 넥이 이중으로 뻗어 케이스가 크고 길어요.",
      posture: "둥근 몸통+넓은 넥. 안는 자세와 왼손 각도 적응 필요.",
      postureRisk: [],
      handSize: "넥 폭이 넓어 손이 작으면 11코스 쪽이 나아요.",
    },
    ...
    caveats: [
      ...
      "바흐를 치고 싶어 시작하는 사람이 많지만, 바흐는 이 악기에서도 어려워요",
      "국내 전공자 극소수 — 사실상 온라인·해외 사사 전제",
    ],
    funFacts: [
      "바이스는 바흐와 동시대에 '류트의 바흐'로 불리며 600곡 이상을 남겼어요",
      "바흐의 류트 작품이 실제 류트용인지 건반용인지는 지금도 학계 떡밥이에요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "르네상스 류트 몸통에 긴 확장 넥을 달아 개방 베이스 현을 추가한 17세기 악기. 독주와 통주저음을 겸하는 만능형으로, 테오르보보다 작고 류트보다 낮아요.",

    sound: {
      tone: ["따뜻함", "낮고 깊음", "부드러움", "나무 울림"],
      toneDesc: "류트의 친밀한 고음과 확장 베이스의 깊은 공명이 한 악기에. 독주에서는 류트답게, 앙상블에서는 저음 기둥으로 변신해요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 2,
      weightDesc: "악기는 2kg 안팎이나 전장 1.2~1.5m. 케이스가 사람 눈높이를 넘어요.",
    ...
    funFacts: [
      "이탈리아 바로크 독주 레퍼토리(피치니니 등)는 아치류트 전용으로 쓰였어요",
      "비발디·헨델 음반의 저음 반주에서 자주 들리는 '통기타 아닌 통기타 소리'가 이것이에요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "전장 2m에 달하는 바로크 통주저음의 왕. 확장 넥의 초장현 베이스가 첼로급 저음을 내고, 몬테베르디 오페라부터 바로크 오케스트라까지 저음 반주석의 터줏대감이에요.",
    ...
    body: {
      ...
      breath: 0,
      weight: 4,
      weightDesc: "무게보다 길이가 문제 — 전장 1.7~2m. 택시·지하철·문틀 모든 곳에서 사건이 생겨요. 항공 이동은 좌석 추가 구매 각.",
    ...
    caveats: [
      ...
      "통주저음(숫자 보고 즉석 화성 만들기)이 본업이라 화성학 공부가 따라와요",
      "이동이 삶의 조건 — 차 없으면 진지하게 재고",
    ],
    funFacts: [
      "국내외 모두 바로크 공연 때 통주저음 주자가 부족해, 손에 익으면 오히려 무대 기회가 생기는 틈새 악기예요",
      "공항 수하물 벨트에서 가장 자주 사진 찍히는 악기라는 농담이 있어요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "17세기의 5코스 더블스트링 기타. 현대 기타보다 작고 가벼우며, 화려한 라스게아도(스트럼)와 섬세한 푼테아도(뜯기)를 오가요. 현대 기타 경험자가 고음악으로 넘어가는 가장 자연스러운 다리.",

    sound: {
      tone: ["반짝임", "따뜻함", "화려함", "소박함"],
      toneDesc: "더블 코스의 찰랑거리는 코러스와 거트계 현의 둥근 음색. 스트럼하면 플라멩코의 먼 조상 같은 리듬감이, 뜯으면 류트 같은 서정이 나요.",
      volume: 2,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "저장력 거트계 현이라 현대 기타보다 손끝이 편해요. 더블 코스 적응만 하면 됨.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "1kg 안팎. 현대 클래식 기타보다 작고 가벼워요.",
    ...
    funFacts: [
      "산스의 곡 '카나리오스'는 로드리고 '어느 귀인을 위한 환상곡'의 원곡이에요",
      "루이 14세의 악기가 바로 이것 — 태양왕은 바로크 기타 애호가였어요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "16세기의 4코스 소형 기타. 우쿨렐레만 한 몸집에 거트현 특유의 순한 소리로, 당대엔 류트의 '만만한 동생' 취급이었지만 지금은 귀여운 고음악 입문 악기예요.",
    ...
    funFacts: [
      "우쿨렐레와 조율 골격이 같아 '16세기 우쿨렐레'로 부르면 대충 맞아요",
      "당대 문헌에 '이발사도 친다'고 적힐 만큼 서민 악기였어요",
    ],
  },

  {
    ...
    sound: {
      ...
      toneDesc: "류트보다 단정하고 기타보다 옛스러운, 마른 나무 향이 나는 소리. 스페인 특유의 그늘진 서정이 배어 있어요.",
      volume: 2,
      sustain: 2,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 1,
      weightDesc: "1kg 안팎. 얇은 몸통이라 가벼워요.",
    ...
    caveats: [
      "레퍼토리가 16세기 스페인 출판보 7권에 사실상 집중 — 깊지만 좁아요",
      "타블라추어가 이탈리아식(숫자 위아래 반전)이라 류트 타브와 또 다름",
      "국내에서 실물을 본 사람이 손에 꼽는 수준",
    ],
    funFacts: [
      "클래식 기타리스트들이 '기타의 뿌리'를 찾아 가장 많이 곁눈질하는 악기예요",
      "나르바에스의 '소 젖 짜는 여인 변주곡'은 기타 편곡으로도 유명해요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "17~18세기의 거트현 만돌린. 피크로 치는 현대 만돌린과 달리 손가락으로 뜯으며, 조율도 4도 위주 — 사실상 '초소형 류트'예요. 비발디 만돌린 협주곡의 원래 주인공.",
    ...
    body: {
      ...
      posture: "부담 없음.",
      postureRisk: [],
      handSize: "초소형 스케일 — 손 큰 사람이 오히려 비좁아요.",
    },

    cost: {
      entryKRW: [2000000, 6000000],
      entryDesc: "국내 판매 없음. 공방 주문·직구 전제(범위 대략치). 작다고 싸지 않아요 — 공정은 류트급.",
      midKRW: [5000000, 12000000],
      running: "현값 정도.",
    },
    practical: {
    ...
    funFacts: [
      "비발디의 유명한 만돌린 협주곡 C장조는 원래 이 거트현 악기를 위한 곡이에요",
      "현대 나폴리 만돌린(쇠줄·피크)은 18세기 후반에야 등장한 '신형'이에요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "철현을 피크로 치는 르네상스 발현악기. 거트현 류트가 '귀족의 악기'였다면 시턴은 이발소에 걸려 있던 '동네 악기' — 튼튼하고 시끄럽고 유쾌해요.",

    sound: {
      tone: ["금속성", "카랑카랑", "반짝임", "소박함"],
      toneDesc: "철현 특유의 챙챙거리는 밝은 울림. 류트족의 촛불 소리와 달리 대낮 장터 소리예요.",
      volume: 3,
      sustain: 3,
    },
    ...
    funFacts: [
      "엘리자베스 시대 이발소에는 손님 대기용 시턴이 걸려 있었어요 — 오늘날 카페 잡지 포지션",
      "철현+얕은 몸통이라 류트보다 조율이 훨씬 오래 버텨요 — 류트 농담의 반대편에 있는 악기",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "류트와 같은 조율에 철현을 얹은 엘리자베스 시대 영국 악기. 프렛과 브리지가 부챗살처럼 비스듬한(슬랜트) 독특한 설계로, 류트 악보를 그대로 철현의 챙챙한 음색으로 연주해요.",

    sound: {
      tone: ["금속성", "반짝임", "신비", "유리 같은"],
      toneDesc: "류트 레퍼토리가 하프시코드 비슷한 금속 광택으로 울려요. 아는 곡이 낯선 옷을 입는 재미.",
      volume: 2,
      sustain: 3,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 1,
      weightDesc: "1.5kg 안팎. 몸통이 얇아 류트보다 안기 편해요.",
      posture: "부담 없음.",
      postureRisk: [],
    ...
    caveats: [
      "전 세계 연주자를 다 모아도 강당 하나가 안 차요 — 진짜 와일드카드 픽",
      "선생·교재가 따로 없고 류트 지식에 얹어 스스로 개척하는 악기",
      "악기 확보가 곧 프로젝트(공방 리서치·주문·대기·직구)",
    ],
    funFacts: [
      "다울랜드 악보 표지에 '류트 또는 오르파리온용'이라 인쇄돼 있어요 — 당대엔 류트의 정식 대체재였어요",
      "이름은 오르페우스+아리온, 그리스 신화 음악가 둘의 합성어예요",
    ],
  },

  {
    ...
    aka: ["bandora", "pandora"],
    family: "발현·류트족",
    desc: "오르파리온의 대형 베이스 버전. 물결치는 외곽선의 큰 몸통에 굵은 철현을 걸어, 엘리자베스 시대 '브로큰 콘소트' 합주의 저음을 담당했어요. 철현 베이스의 원조 격.",
    ...
    caveats: [
      "합주 전용에 가까운 악기 — 브로큰 콘소트를 짤 동료가 없으면 쓸 곳이 마땅치 않아요",
      "국내 연주자·악기 모두 사실상 0에서 시작하는 완전 개척지",
      "독주 악보가 극히 적음",
    ],
    funFacts: [
      "1562년 런던의 존 로즈가 발명했다고 기록된, '발명자가 남아 있는' 드문 르네상스 악기예요",
      "셰익스피어 시대 극장 음악(브로큰 콘소트)의 저음이 바로 이 소리였어요",
    ],
  },

  {
    ...
    family: "발현·류트족",
    desc: "18세기 독일어권의 6~8코스 베이스 류트. 기타와 거의 같은 조율이라 '기타 감각으로 치는 류트'로 통하며, 바로크 류트의 D단조 미로를 우회해 고음악에 진입하는 지름길이에요.",

    sound: {
      tone: ["낮고 깊음", "따뜻함", "부드러움", "나무 울림"],
      toneDesc: "류트의 여림과 기타의 친숙함 사이. 낮게 가라앉은 저음이 노래 반주에 특히 좋아요.",
      volume: 2,
      sustain: 3,
    },
    ...
    caveats: [
      "인지도가 낮아 '류트냐'는 질문에 매번 설명이 길어져요",
      "악보·연구가 최근에야 발굴되는 중 — 레퍼토리 지도가 아직 그려지는 악기",
      "국내 연주자 사실상 없음",
    ],
    funFacts: [
      "기타 조율과 거의 같아 기타리스트가 '치팅'으로 바로크에 입장할 수 있는 뒷문으로 불려요",
      "텔레만이 이 악기를 위한 협주곡을 남겼어요",
    ],
  },

  {
    ...
    family: "발현·치터족",
    desc: "울림통 위에 현을 나란히 걸고 손가락·깃펜으로 뜯는 중세 악기. 프렛도 버튼도 없이 현 하나 = 음 하나라 구조가 가장 원시적이고, 그래서 가장 진입이 쉬워요. 시편(Psalm)과 어원을 나눈 악기.",

    sound: {
      tone: ["영롱함", "맑음", "신비", "소박함"],
      toneDesc: "작은 하프와 오르골 사이의 짧고 맑은 울림. 중세 성가나 캐럴을 얹으면 수도원 채플 공기가 나요.",
      volume: 2,
      sustain: 3,
    },
    ...
    caveats: [
      ...
      "레퍼토리를 스스로 얹어야 하는 악기 — '살터리 교본' 같은 건 없어요",
      "활로 켜는 '보우드 살터리'는 20세기 발명품으로 사실상 다른 악기이니 구매 시 구분할 것",
    ],
    funFacts: [
      "중세 그림·성당 조각에서 천사가 들고 있는 납작한 현악기가 대개 이것이에요",
      "해머드 덜시머와 몸은 같고 주법만 달라요 — 뜯으면 살터리, 치면 덜시머",
    ],
  },
