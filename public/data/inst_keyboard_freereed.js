...
const INST_KEYBOARD_FREEREED = [
  ...
  // ═══════════════ 1. 피아노 ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "여리게 치면 물방울처럼 영롱하고, 세게 치면 오케스트라처럼 웅장하다. 한 악기 안에 속삭임부터 포효까지 다 들어있는 넓은 표현 폭이 최대 무기.",
      volume: 4,
      sustain: 4,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 다만 장시간 연습 시 손가락·손목 피로는 있다.",
      embouchure: 0,
      breath: 0,
      weight: 5,
      weightDesc: "어쿠스틱은 200kg+로 이동 자체가 없는 '가구'. 대신 집에 두면 운반 부담도 없다.",
    ...
    tracks: [
      { id: "classical", label: "클래식", genres: ["클래식"], note: "체르니-소나타로 이어지는 정통 코스. 악보 독해력이 재산이 된다." },
      { id: "jazz", label: "재즈 피아노", genres: ["재즈"], note: "코드 보이싱과 즉흥. 클래식과 완전히 다른 두뇌를 쓴다." },
      ...
      { id: "ccm", label: "CCM·교회 반주", genres: ["CCM·교회음악"], note: "코드 이해+즉흥 반주. 교회라는 확실한 무대가 생긴다." },
    ],
    ...
    caveats: [
      "세상에서 경험자가 제일 많은 악기 — '잘 치는 사람'의 기준선이 매우 높다.",
      "어쿠스틱을 아파트에 들이는 건 별개의 프로젝트(방음·민원). 현실은 디지털부터.",
      "혼자 완결되는 악기라 오히려 합주 기회를 스스로 찾지 않으면 평생 독주만 하게 된다.",
    ],
    funFacts: ["정식 명칭 피아노포르테는 '여리게(piano)도 세게(forte)도 칠 수 있다'는 뜻 — 등장 당시엔 혁명이었다."],
  },
  ...
  // ═══════════════ 2. 파이프오르간 ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "성당을 통째로 울리는 압도적인 음량과, 스톱 조합에 따라 플루트·트럼펫·현악기까지 흉내 내는 천 개의 얼굴. 저음 파이프는 몸으로 진동이 느껴진다.",
      volume: 5,
      sustain: 5,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 건반 터치는 피아노보다 가볍다.",
      embouchure: 0,
      breath: 0,
      weight: 5,
      weightDesc: "소유·운반 개념이 없는 악기. 내가 악기가 있는 곳(교회·홀)으로 간다.",
    ...
    cost: {
      ...
      entryDesc: "진짜 파이프오르간은 개인 소유 대상이 아님(수억~수십억). 집 연습용 3단+발건반 디지털 클래식 오르간(수입) 기준 500만~3000만. 실제 입문 비용은 교회·대학 연습실 사용료가 전부인 경우도 많다.",
    ...
    caveats: [
      "최대 장벽은 실력이 아니라 접근성 — 연습할 악기가 있는 교회·학교와의 연결이 먼저다.",
      "발건반은 완전히 새로운 신체 훈련. 피아노를 잘 쳐도 처음엔 발이 따로 논다.",
      "레슨은 교회음악과·오르가니스트 개인 레슨 등 소수 경로뿐(서울 중심).",
    ],
    funFacts: ["음을 누르는 동안 무한히 지속되는 몇 안 되는 악기 — 바흐 시대엔 사람이 밟는 풀무로 바람을 넣었다."],
  },
  ...
  // ═══════════════ 3. 하몬드오르간 ═══════════════
  {
    ...
    family: "건반·전기기계식 오르간",
    desc: "회전하는 톤휠로 소리를 만드는 전기 오르간. 드로우바로 배음을 실시간 조합하고, 회전 스피커(레슬리)가 특유의 소용돌이 사운드를 만든다. 재즈·소울·가스펠의 심장.",

    sound: {
      tone: ["그루브", "따뜻함", "빵빵함", "몽환", "콧소리"],
      toneDesc: "레슬리 스피커가 빙글빙글 돌며 만드는 출렁이는 소용돌이 사운드. 드로우바를 밀고 당길 때마다 음색이 즉석에서 변하고, 퍼커시브한 클릭감이 그루브를 만든다.",
      volume: 4,
      sustain: 5,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 건반이 가벼워 글리산도·속주가 손에 부담 없다.",
      embouchure: 0,
      breath: 0,
      weight: 4,
      weightDesc: "빈티지 B3+레슬리는 150kg+ '이사 지옥'. 현실 연주자는 10kg대 클론휠 키보드를 든다.",
      posture: "앉거나 서서. 왼손 베이스+오른손 코드·솔로를 동시에 굴리는 멀티태스킹.",
      postureRisk: ["목어깨"],
      handSize: "피아노와 동일. 손바닥으로 뭉개는 주법도 많아 손 크기 부담은 오히려 적다.",
    },
    ...
    cost: {
      ...
      running: "클론휠은 유지비 0. 빈티지는 오일 주입·진공관·수리로 돈과 애정이 계속 든다.",
    },
    practical: {
      portability: 2,
      noise: 4,
    ...
    caveats: [
      "피아노와 주법 철학이 다름 — 서스테인 페달이 없어 손가락으로 음을 잇는 레가토를 새로 배운다.",
      "국내 전문 레슨은 드묾. 재즈 피아노 레슨+유튜브(영어권 자료 풍부)로 우회하는 게 현실.",
      "빈티지 낭만에 빠지면 지갑과 허리가 동시에 무너진다 — 입문은 반드시 클론휠로.",
    ],
    funFacts: ["원래는 교회가 파이프오르간을 살 돈이 없어 만든 '저가 대체품'이었는데, 그 소리가 재즈와 록의 아이콘이 됐다."],
  },
  ...
  // ═══════════════ 4. 하프시코드 ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "현을 뜯는 구조라 찰랑거리는 금속성 광택이 있다. 셈여림이 없는 대신 음이 보석처럼 또렷하게 구르며, 두 단 건반과 스톱으로 음색을 바꾼다.",
      volume: 3,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 건반이 매우 가벼워 손 부담이 피아노보다 훨씬 적다.",
      embouchure: 0,
      breath: 0,
      weight: 5,
    ...
    variants: [
      { id: "digital_hpsd", label: "디지털 하프시코드", mods: { noise: 1, weight: 3 }, note: "롤랜드 클래식 시리즈 등. 신품 단종이 많아 중고 위주지만 조율·관리 걱정이 사라진다." },
    ],

    caveats: [
      "셈여림(강약)이 안 됨 — 표현은 전적으로 아티큘레이션과 타이밍. 피아노와는 다른 미학을 처음부터 배운다.",
      "조율이 취미의 일부. 연주 전 15분 조율이 일상이 된다.",
      "국내 레슨은 고음악 전공자 소수(서울 중심). 대신 피아노 실력이 있으면 전환 자체는 빠르다.",
    ],
    funFacts: ["바흐의 골드베르크 변주곡은 원래 이 악기를 위한 곡 — 2단 건반이 있어야 손이 안 꼬이는 대목이 있다."],
  },
  ...
  // ═══════════════ 5. 클라비코드 ═══════════════
  {
    ...
    aka: ["clavichord"],
    family: "건반·타현악기",
    desc: "금속 탄젠트가 현을 아래에서 밀어 올리는, 세상에서 가장 조용한 건반악기. 바흐가 아들 교육용으로 아꼈던 '개인용' 악기. 건반악기 중 유일하게 비브라토가 된다.",

    sound: {
      tone: ["소박함", "따뜻함", "먹먹함", "숨소리 섞임", "노래하는 듯"],
      toneDesc: "속삭임 수준의 아주 작은 소리. 대신 건반을 누른 채 흔들면 음이 떨리는 비브라토(베붕)가 되고, 손끝의 미세한 압력이 그대로 소리에 실리는, 가장 '살갗에 가까운' 건반이다.",
      volume: 1,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 다만 터치가 극도로 예민해 손끝 감각 훈련이 곧 연습이다.",
      embouchure: 0,
      breath: 0,
      weight: 3,
      weightDesc: "10~25kg 상자형. 건반악기 중 드물게 혼자 옮길 수 있다.",
      posture: "앉은 자세, 부담 없음.",
      postureRisk: [],
    ...
    practical: {
      portability: 3,
      noise: 1,
      apartmentOk: "밤 12시에 쳐도 옆방에서도 잘 안 들린다 — 소음 걱정이라는 개념 자체가 없는, 아파트 최강의 어쿠스틱 건반.",
      selfLearn: 2,
      lessonKR: 1,
      entryBarrier: 3,
      quickReward: 2,
    ...
    ensemble: ["독주 전용 — 소리가 작아 합주에선 묻힌다"],

    caveats: [
      "소리가 작다는 건 남에게 안 들린다는 뜻이기도 — 무대·합주 욕심이 있다면 다른 악기다.",
      "터치가 예민해 세게 누르면 음정이 휘어버린다. 피아노 습관을 버리는 데 시간이 걸린다.",
      "국내에서 실물을 본 사람조차 드묾. 레슨은 사실상 없고 악기도 직구 — 각오가 필요한 취미.",
    ],
    funFacts: ["C.P.E. 바흐는 '내 심장을 아는 악기'라 불렀다 — 헤드폰 시대 이전의 진정한 개인 연습 악기."],
  },
  ...
  // ═══════════════ 6. 첼레스타 ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "오르골을 건반으로 치는 듯한, 반짝이는 천상의 종소리. 어떤 곡이든 이 소리가 얹히는 순간 마법·꿈·눈 내리는 밤의 이미지가 된다.",
      volume: 2,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 피아노 치듯 그대로 친다.",
      embouchure: 0,
      breath: 0,
      weight: 5,
      weightDesc: "50~90kg 캐비닛형. 개인이 옮기거나 소유할 일이 거의 없다.",
      posture: "앉은 자세, 부담 없음.",
      postureRisk: [],
    ...
    cost: {
      ...
      entryDesc: "개인 구매 영역이 아님 — 신품(슈이드마이어 등) 수천만원대. 현실적으로는 오케스트라·스튜디오·대학 소유 악기를 연주하거나, 디지털 건반의 첼레스타 음색으로 대신한다.",
      midKRW: [40000000, 90000000],
      running: "조율·관리는 보유 기관 몫. 개인 유지비 개념이 없다.",
    },
    practical: {
      portability: 1,
      noise: 2,
      apartmentOk: "음량은 작지만 애초에 집에 있을 악기가 아니다. 재택 연습=디지털 건반 음색.",
      selfLearn: 2,
      lessonKR: 1,
      entryBarrier: 2,
      quickReward: 4,
    ...
    caveats: [
      "'내 악기'로 삼기 어려운 악기 — 전공 건반 주자가 오케스트라에서 겸하는 포지션이지, 단독 입문 경로가 사실상 없다.",
      "이 소리가 좋아서라면 현실 답은 피아노+디지털 음색이거나, 사촌 격인 글로켄슈필이다.",
    ],
    funFacts: ["차이콥스키가 호두까기 인형 '사탕요정의 춤'에 쓰려고 파리에서 몰래 들여왔다 — 경쟁 작곡가가 먼저 쓸까 봐 비밀에 부쳤다."],
  },
  ...
  // ═══════════════ 7. 토이피아노 ═══════════════
  {
    ...
    family: "건반·타악기(금속봉)",
    desc: "해머가 금속봉을 때리는 소형 건반. 장난감으로 태어났지만 존 케이지 이후 어엿한 연주회 악기가 됐다. 삐뚤빼뚤 사랑스러운 음색의 인디·실험음악 아이콘.",

    sound: {
      tone: ["귀여운", "반짝임", "소박함", "금속성", "유리 같은"],
      toneDesc: "오르골과 실로폰 사이의 땡글땡글한 소리. 미묘하게 어긋난 조율이 오히려 꿈결 같고 아련한 분위기를 만든다.",
      volume: 2,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 다만 건반이 얕고 튕겨서 섬세한 컨트롤이 의외로 어렵다.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "2~7kg. 한 손에 들고 다니는 건반.",
      posture: "바닥에 앉거나 테이블 위에 놓고 연주. 낮은 악기라 오래 치면 등이 굽는다.",
      postureRisk: ["허리"],
      handSize: "미니 건반이라 손이 크면 오히려 답답하다.",
    },
    ...
    caveats: [
      "음역이 2~3옥타브뿐이라 칠 수 있는 곡이 근본적으로 제한된다.",
      "조율이 안 맞는 게 정체성 — 정확한 음정을 원하면 스트레스받는다.",
      "메인 악기라기보다 '두 번째 악기'나 작곡·녹음의 양념으로 최고.",
    ],
    funFacts: ["존 케이지가 1948년 '토이피아노를 위한 모음곡'을 쓰면서 콘서트홀에 입성 — 지금도 이 악기 전문 연주자가 존재한다."],
  },
  ...
  // ═══════════════ 8. 신디사이저 ═══════════════
  {
    ...
    family: "건반·전자악기",
    desc: "소리 자체를 회로(또는 소프트웨어)로 설계하는 전자 건반. 세상에 없는 음색을 내가 만든다. 연주 악기이자 작곡·프로듀싱 도구.",

    sound: {
      tone: ["몽환", "빵빵함", "금속성", "신비", "그루브"],
      toneDesc: "따뜻한 아날로그 베이스부터 우주적인 패드, 찢어지는 리드까지 — 음색의 한계가 없다. '어떤 소리인가'가 아니라 '어떤 소리를 만들 것인가'의 악기.",
      volume: 3,
      sustain: 5,
    },
    ...
    cost: {
      ...
      entryDesc: "볼카 시리즈 등 미니 신스 20만~, 마이크로프리크급 40만~, 61키 신스 워크스테이션 입문형 60만~100만. 무료 신스 플러그인+미디 키보드(10만 이하)로 시작하는 길도 있다.",
    ...
    caveats: [
      "건반 실력과 별개로 신디시스(음색 설계)라는 두 번째 공부가 있다 — 이게 재미이자 러닝커브.",
      "연습보다 장비 검색에 시간을 더 쓰게 되는 함정(GAS)이 실존한다.",
      "'악기 하나를 마스터했다'는 성취감보다는 끝없는 탐험에 가깝다.",
    ],
    funFacts: ["무그 신디사이저의 데뷔 앨범(스위치드 온 바흐, 1968)은 바흐 연주곡 — 신스는 태생부터 클래식과 전자음악의 다리였다."],
  },
  ...
  // ═══════════════ 9. 키타(keytar) ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "본질은 신디사이저 — 리드 솔로용 쨍한 신스음이 시그니처. 넥의 리본·휠로 기타처럼 벤딩·비브라토를 걸며 솔로를 지른다.",
      volume: 3,
      sustain: 5,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 2,
      weightDesc: "3~5kg을 어깨끈으로 멤. 기타보다 가볍지만 공연 내내 메면 어깨에 온다.",
    ...
    caveats: [
      "키타 전용 레슨은 없다 — 결국 건반 실력이 본체고, 키타는 그걸 무대용으로 바꾸는 장비다.",
      "혼자 집에서 칠 땐 그냥 불편한 건반 — 무대·밴드가 없으면 존재 이유가 반감된다.",
  ...
  // ═══════════════ 10. 멜로디카 ═══════════════
  {
    ...
    family: "프리리드·건반취주악기",
    desc: "입으로 불며 건반을 누르는 프리리드 악기. 초등학교 그 악기 맞지만, 재즈·덥·버스킹에서 어엿한 성인 악기로 재발견됐다. 건반+관악의 표현력을 3만원에.",

    sound: {
      tone: ["콧소리", "소박함", "따뜻함", "애수"],
      toneDesc: "아코디언과 하모니카 사이의 콧소리 섞인 리드 사운드. 호흡으로 강약·비브라토가 걸려서 건반인데도 노래하듯 표현된다.",
      volume: 3,
      sustain: 4,
    },
    ...
    body: {
      ...
      breath: 1,
      weight: 1,
      weightDesc: "500g~1kg. 가방에 쏙 들어간다.",
    ...
    caveats: [
      "침이 안에 고인다 — 연주 후 물 빼고 말리지 않으면 냄새·곰팡이. 이게 유일하고 확실한 단점.",
      "'애들 악기' 이미지가 있어 무대에선 오히려 반전 카드가 되기도, 벽이 되기도 한다.",
      "숨이 이어지는 만큼만 소리가 난다 — 긴 프레이즈는 호흡 설계가 필요.",
    ],
    funFacts: ["자메이카의 어거스터스 파블로가 이 악기로 덥 음악의 전설이 됐다 — 학교 악기가 장르의 목소리가 된 드문 사례."],
  },
  ...
  // ═══════════════ 11. 피아노 아코디언 ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "여러 리드가 한꺼번에 울리는 풍성한 합창 같은 소리. 벨로우즈로 숨을 쉬듯 강약을 만들어서, 건반악기인데 관악기처럼 노래한다. 뮈제트 튜닝이면 특유의 파리풍 흔들림이 얹힌다.",
      volume: 4,
      sustain: 5,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 대신 왼팔이 벨로우즈를 밀고 당기느라 은근히 근력 운동이 된다.",
      embouchure: 0,
      breath: 0,
      weight: 4,
      weightDesc: "성인용 8~13kg을 어깨끈 두 줄로 멘다. 앉아 연주하면 허벅지가 받쳐줘서 생각보다 버틸 만하지만, 서서 오래 하면 확실히 온다.",
    ...
    cost: {
      ...
      entryDesc: "중국산 신품(파로셀 등) 60만~120만, 중고 이탈리아·독일산 150만~. 사이즈(베이스 수)에 따라 가격 폭이 크다. 처음엔 72베이스 안팎 중고 추천.",
    ...
    tracks: [
      ...
      { id: "tango", label: "탱고", genres: ["탱고"], note: "반도네온의 현실적 대체 경로. 피아졸라 곡의 아코디언 편곡 악보가 풍부하다." },
      { id: "trot", label: "트로트·가요", genres: ["트로트·가요"], note: "한국 아코디언의 주류 씬. 동호회·행사 무대가 많고 중장년 레슨 인프라가 여기에 있다." },
      { id: "folk", label: "포크·월드", genres: ["포크", "발칸·클레즈머·집시"], note: "클레즈머·발칸·아이리시까지. 버스킹 한 대로 완결되는 밴드." },
    ],

    variants: [
      { id: "digital_acc", label: "디지털 아코디언", mods: { noise: 1 }, note: "롤랜드 FR 시리즈. 헤드폰 연습 가능하지만 가격(200만~)이 만만치 않다." },
    ],

    caveats: [
      "무게가 진짜 변수 — 시작 전에 반드시 실물을 메 보고 사이즈를 정할 것.",
      "왼손 베이스 버튼 120개는 안 보이는 위치를 외우는 악기 — 초반 두어 달은 왼손이 미아가 된다.",
      "국내 수리·조율 기술자가 소수라, 악기 상태 좋은 매물 고르는 눈(또는 도와줄 사람)이 중요하다.",
    ],
    funFacts: ["세계에서 가장 많이 팔린 악기 중 하나 — 20세기 중반 미국에선 피아노보다 아코디언 학원이 많던 시절도 있었다."],
  },
  ...
  // ═══════════════ 12. 바얀 ═══════════════
  {
    ...
    family: "프리리드·벨로우즈(주름상자)",
    desc: "러시아식 크로매틱 버튼 아코디언(B시스템). 바흐 오르간곡부터 현대 창작곡까지 소화하는 '클래식 연주용 아코디언'의 표준. 러시아·동구권에선 음악원 전공 악기다.",
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "굳은살 없음. 버튼이 가벼워 손끝 부담은 적다.",
      embouchure: 0,
      breath: 0,
      weight: 5,
      ...
      postureRisk: ["허리", "목어깨"],
      handSize: "버튼 간격이 건반보다 훨씬 좁아 손 작은 사람이 오히려 유리 — 한 손으로 2옥타브가 잡힌다.",
    },

    cost: {
      entryKRW: [1500000, 4000000],
      entryDesc: "국내 유통 사실상 없음 — 러시아·유럽 직구 기준. 툴라(Tula) 등 학생용 신품 150만~400만, 중고는 운이 따라야 한다. 콘서트급(주피터 등)은 수천만원.",
      midKRW: [5000000, 20000000],
    ...
    caveats: [
      "한국에 레슨·수리·악기 유통 인프라가 거의 없다 — 유학파 연주자 소수와 온라인(러시아어권 자료가 최상급)이 전부.",
      "B시스템 교재·운지 자료는 러시아어가 표준 — 영어 자료도 C시스템 위주라 걸러 봐야 한다.",
      "비르투오소 문화의 악기라 정상은 아득히 높다 — 대신 취미 수준에서도 버튼 배열의 효율은 그대로 누린다.",
    ],
    funFacts: ["이름은 전설의 음유시인 '보얀'에서 왔다. 러시아에선 음악원에 바얀 전공이 정식으로 있고 국제 콩쿠르도 열린다."],
  },
  ...
  // ═══════════════ 13. 크로매틱 버튼 아코디언 ═══════════════
  {
    ...
    family: "프리리드·벨로우즈(주름상자)",
    desc: "서유럽식(C시스템) 버튼 아코디언. 버튼 배열이 조옮김에 대칭이라 한 운지를 외우면 12키가 전부 열린다. 프랑스 뮈제트·발칸·재즈 아코디언의 표준.",

    sound: {
      tone: ["애수", "화려함", "따뜻함", "빵빵함", "노래하는 듯"],
      toneDesc: "소리는 피아노 아코디언과 같은 계열 — 차이는 손끝에 있다. 좁은 버튼 덕에 건반으로는 안 잡히는 넓은 도약과 빽빽한 화음이 잡히고, 속주가 매끈해진다.",
      volume: 4,
      sustain: 5,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 4,
      weightDesc: "8~13kg. 같은 음역이면 피아노 아코디언보다 작고 가볍게 나온다.",
    ...
    cost: {
      ...
      entryDesc: "국내 매장 취급이 드물어 유럽 직구·중고 기준. 중국산 신품 120만~, 이탈리아·프랑스산 중고 200만~. 피아노식보다 매물 자체가 귀하다.",
    ...
    tracks: [
      ...
      { id: "balkan", label: "발칸·클레즈머", genres: ["발칸·클레즈머·집시"], note: "변박·초고속 프레이즈의 세계. 대칭 배열이 조바꿈 많은 곡에서 진가를 낸다." },
      { id: "jazz_cba", label: "재즈", genres: ["재즈"], note: "리샤르 갈리아노 계보. 벨로우즈 셰이크 등 표현 주법의 놀이터." },
    ],

    caveats: [
      "한국은 피아노 아코디언이 표준이라 C시스템 레슨·교재를 찾기 어렵다(프랑스어·이탈리아어권 자료가 본진).",
      "피아노를 오래 쳤다면 건반식이 즉시 편하고, 버튼식은 백지에서 다시 외운다 — 대신 천장이 더 높다.",
      "B시스템(바얀)과 배열이 달라 교재·영상 볼 때 시스템 확인이 필수.",
    ],
    funFacts: ["같은 손 모양을 그대로 옮기면 조옮김이 끝난다 — 12키를 각각 새로 배우는 건반과의 결정적 차이."],
  },
  ...
  // ═══════════════ 14. 다이어토닉 버튼 아코디언 ═══════════════
  {
    ...
    sound: {
      ...
      toneDesc: "밀당이 만드는 통통 튀는 리듬감이 소리에 배어 있다. 크로매틱보다 단순하고 시원한, 춤을 부르는 소리. 아이리시 릴이 쏟아질 때의 추진력이 시그니처.",
      volume: 4,
      sustain: 4,
    },
    ...
    caveats: [
      "밀 때와 당길 때 음이 달라 악보를 그대로 옮기는 악기가 아니다 — 귀와 몸으로 패턴을 익히는 구전 음악 방식이 정석.",
      "악기 하나가 조성 2~3개 전용 — 장르 표준 키(아이리시 B/C, 노르테뇨 GCF)를 모르고 사면 낭패.",
      "국내 레슨은 사실상 없음. 커뮤니티도 극소수 — 온라인 영어권 강좌가 실질 스승.",
    ],
    funFacts: ["같은 버튼인데 밀면 '도', 당기면 '레' — 이 제약이 오히려 아이리시 특유의 통통 튀는 프레이징을 만든다."],
  },
  ...
  // ═══════════════ 15. 반도네온 ═══════════════
  {
    ...
    desc: "탱고의 영혼. 71버튼이 무질서하게 흩어진 사각 콘서티나족 악기로, 밀 때와 당길 때 음이 다르다. 피아졸라가 세계에 각인시킨, 세상에서 가장 배우기 어려운 악기 중 하나.",

    sound: {
      tone: ["애수", "먹먹함", "낮고 깊음", "숨소리 섞임", "노래하는 듯"],
      toneDesc: "울다가 으르렁거리는 소리. 벨로우즈를 당겨 여는 순간의 한숨 같은 어택과, 무릎을 치며 끊는 스타카토가 탱고의 심장박동을 만든다. 아코디언보다 건조하고 사람 목소리에 가깝다.",
      volume: 3,
      sustain: 4,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 3,
      weightDesc: "4~5kg을 무릎 위에 올리고 연주. 어깨끈이 없어 몸 부담은 아코디언보다 훨씬 적다.",
      posture: "앉아서 무릎 위. 벨로우즈를 크게 벌리는 동작에서 등이 굽기 쉽다.",
      postureRisk: ["허리", "목어깨"],
    ...
    caveats: [
      "배열이 '지옥' — 오른손·왼손·밀 때·당길 때가 전부 달라 사실상 4개의 무질서한 자판을 통째로 외운다. 역사적 우연이 굳어진 배열이라 논리도 없다.",
      "악기 구하기가 배우기보다 어렵다 — 좋은 중고(도블레 A 등)는 세계적으로 품귀이고 가격은 계속 오르는 중.",
      "국내 연주자·교사가 손에 꼽힌다. 레슨은 소수 연주자 개인 레슨 또는 해외 온라인이 전부.",
      "이 모든 벽을 넘을 만큼 탱고를 사랑하는가 — 이 질문에 '예'인 사람만 오는 악기.",
    ],
    funFacts: ["원래 독일에서 교회 오르간 대용으로 만든 악기가 이민선을 타고 부에노스아이레스 항구에 내려 탱고의 목소리가 됐다."],
  },
  ...
  // ═══════════════ 16. 콘서티나 ═══════════════
  {
    ...
    body: {
      ...
      breath: 0,
      weight: 1,
      weightDesc: "1~1.5kg. 아코디언 가족 최경량 — 가방에 넣어 다닌다.",
    ...
    cost: {
      ...
      entryDesc: "중국산 입문기 30만~60만(직구), 입문 표준 로셸(Rochelle)급 60만~90만. 국내 매장 유통은 거의 없다.",
    ...
    tracks: [
      { id: "anglo", label: "앵글로(아이리시)", genres: ["켈틱·아이리시"], note: "밀당 바이소노릭. 아이리시 세션의 표준 — 온라인 강좌(OAIM 등)로 독학 루트가 열려 있다." },
      { id: "english", label: "잉글리시(멜로디·클래식형)", genres: ["포크", "클래식"], note: "밀당 같은 음이라 악보 연주에 유리. 잉글랜드 포크·찬송가·클래식 소품에 어울린다." },
    ],

    caveats: [
      "앵글로/잉글리시/듀엣 시스템이 서로 호환 안 됨 — 처음에 장르 보고 시스템을 정해야 갈아타는 비용이 없다.",
      "저가 중국제는 반응 속도·벨로우즈 한계로 1~2년 안에 업그레이드 욕구가 온다(그리고 중급부턴 가격이 훌쩍 뛴다).",
      "국내 레슨·커뮤니티 사실상 없음 — 영어권 온라인 강좌가 실질 스승.",
    ],
    funFacts: ["19세기 영국에선 상류층 살롱 악기였다 — 찰스 다윈 시대의 '교양 악기'가 지금은 아이리시 펍의 소리가 됐다."],
  },
  ...
  // ═══════════════ 17. 다이어토닉 하모니카 ═══════════════
  {
    ...
    family: "프리리드·하모니카족",
    desc: "주머니에 들어가는 10홀 하모니카. 벤딩(음 구부리기)으로 블루스 특유의 우는 소리를 낸다. 세계에서 가장 싸게 시작해서 가장 깊이 갈 수 있는 악기 중 하나.",

    sound: {
      tone: ["애수", "거칢", "콧소리", "숨소리 섞임", "노래하는 듯"],
      toneDesc: "숨이 그대로 소리가 되는 악기. 벤딩이 걸리는 순간 흐느끼고, 핸드 와우로 울렁이고, 기차 리듬으로 달린다. 목소리 다음으로 사람 감정에 가까운 소리.",
      volume: 3,
      sustain: 4,
    },
    ...
    body: {
      ...
      posture: "자세 부담 전무. 걸으면서도, 누워서도 분다.",
      postureRisk: [],
    ...
    cost: {
      ...
      midKRW: [80000, 300000],
      running: "리드 수명이 있어 소모품 개념(연주량 따라 1~3년). 조성별로 하나씩 늘어난다.",
    },
    practical: {
      portability: 5,
      noise: 3,
      apartmentOk: "리코더급 음량. 낮 연습 무난, 밤엔 이불 속 약음 연습이라는 전통 기술이 있다.",
      selfLearn: 5,
      lessonKR: 3,
      entryBarrier: 1,
      quickReward: 5,
    ...
    caveats: [
      "벤딩을 익히기 전까지는 '블루스 그 소리'가 안 난다 — 여기서 그만두는 사람이 제일 많다.",
      "한 조성=한 악기라 결국 5~7개를 모으게 된다(그래도 다 합쳐 기타 한 대 값).",
      "노래하면서 연주는 불가 — 입이 하나라서. 대신 넥 홀더로 기타와는 병행된다.",
    ],
    funFacts: ["밥 딜런·닐 영·스티비 원더까지 — 주머니 속 악기로 무대 최전선에 선 사람이 이렇게 많은 악기도 드물다."],
  },
  ...
  // ═══════════════ 18. 크로매틱 하모니카 ═══════════════
  {
    ...
    family: "프리리드·하모니카족",
    desc: "옆의 슬라이드 버튼을 누르면 반음이 올라가는 하모니카. 12조성을 한 대로 소화해 재즈·클래식 멜로디를 정면으로 연주한다. 투츠 틸레망스의 악기.",
    ...
    body: {
      ...
      posture: "부담 없음. 슬라이드 조작하는 오른손 검지만 바빠진다.",
      postureRisk: [],
      handSize: "손 크기 무관.",
    },
    ...
    cost: {
      ...
      entryDesc: "호너 크로모니카·스즈키·이스트탑 입문기 8만~20만, 표준기(호너 270 등) 20만~40만. 다이어토닉보다 확실히 비싸지만 한 대로 12키가 된다.",
    ...
    caveats: [
      "화음 반주가 사실상 안 되는 순수 멜로디 악기 — 반주자(또는 반주 음원)와 함께일 때 완성된다.",
      "밸브·슬라이드가 침과 온도에 예민해 관리가 다이어토닉보다 손이 간다(연주 전 데우기 습관).",
      "벤딩 표현은 다이어토닉보다 제한적 — 블루스 필이 목적이라면 다이어토닉이 맞다.",
    ],
    funFacts: ["투츠 틸레망스는 이 악기로 재즈 명예의 전당급 커리어를 쌓았고, 미드나잇 카우보이·세서미 스트리트의 그 멜로디도 그의 크로매틱이다."],
  },
  ...
  // ═══════════════ 19. 트레몰로 하모니카 ═══════════════
  {
    ...
    family: "프리리드·하모니카족",
    desc: "한 음에 리드 2개가 미세하게 어긋나 울리며 떨림(트레몰로)을 만드는 하모니카. 한국 하모니카 교실·동호회의 표준으로, 트로트·가요·옛 노래와 궁합이 가장 좋다.",

    sound: {
      tone: ["애수", "따뜻함", "콧소리", "소박함", "노래하는 듯"],
      toneDesc: "두 리드가 만드는 아련한 떨림이 기본 장착된 소리. 고향의 봄이든 트로트든, 부는 순간 그리움 필터가 걸린다. 한국인의 귀에 가장 익숙한 하모니카 소리.",
      volume: 3,
      sustain: 4,
    },
    ...
    caveats: [
      ...
      "특유의 떨림이 매력이자 호불호 — 깔끔한 단음을 원하면 다이어토닉·크로매틱이 맞다.",
      "젊은 층 씬은 얇지만, 중장년 레슨·합주 인프라(문화센터·복지관)는 국내 악기 중 최상위권.",
    ],
    funFacts: ["국내 문화센터·복지관 하모니카 강좌의 사실상 표준 악기 — '레슨 구하기 쉬움' 하나만큼은 희귀 악기들이 부러워할 스펙이다."],
  },
  ...
  // ═══════════════ 20. 생황 ═══════════════
  {
    ...
    aka: ["saenghwang", "笙簧", "생"],
    family: "프리리드·국악 관악기",
    desc: "박통에 17개의 대나무 관을 꽂은 한국 전통 프리리드 관악기. 국악기 중 유일하게 화음을 내는 관악기로, 들숨·날숨 모두 소리가 난다. 최근 창작국악·크로스오버에서 재조명 중.",

    sound: {
      tone: ["신비", "영롱함", "맑음", "숨소리 섞임", "명상적"],
      toneDesc: "파이프오르간을 축소한 듯한, 유리질의 신비로운 화음. 여러 관이 동시에 울리는 소리는 국악기라기보다 우주적이라는 말이 어울린다. 봉황 울음소리에 비유돼 온 소리.",
      volume: 3,
      sustain: 5,
    },
    ...
    body: {
      ...
      breath: 2,
      weight: 1,
      weightDesc: "1kg 안팎. 두 손으로 감싸 안고 분다.",
    ...
    caveats: [
      "온도에 극도로 예민 — 차가운 악기는 리드에 습기가 맺혀 음이 안 나서, 연주 전 품에 안거나 데워 쓰는 게 기본기다.",
      "조율·수리 가능한 곳이 국내 극소수 — 악기 상태 관리가 취미의 절반.",
      "레슨은 국악과 전공자·소수 연주자 개인 레슨 위주(서울 중심). 독학 교재는 거의 없다.",
      "정악 문화의 악기라 즉흥·밴드 합주보다는 합주단·앙상블 문맥이 어울린다.",
    ],
    funFacts: ["3천 년 된 이 악기의 원리가 서양으로 건너가 하모니카·아코디언·오르간 리드의 조상이 됐다 — 프리리드 가족의 큰어른."],
  },
