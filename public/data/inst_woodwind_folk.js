...
const INST_WOODWIND_FOLK = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    desc: "호리병(표주박)에 프리리드 관을 꽂은 윈난 소수민족 악기. 리드가 관 속에 내장돼 하모니카처럼 불면 바로 소리가 나고, 톤은 클라리넷을 닮은 매끈한 벨벳. 드론 관이 달려 혼자서도 지속음(드론) 반주가 깔린다.",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    sound: {
      ...
      toneDesc: "하이랜드의 포효와 딴판인, 울면서 노래하는 소리. 챈터 끝을 무릎에 댔다 떼며 만드는 스타카토·레가토 전환과 2옥타브 음역이 백파이프계 유일의 표현력을 만든다.",
      volume: 3,
      sustain: 5,
    },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    family: "민속 목관·백파이프(입김 충전)",
    desc: "스페인 북서부 갈리시아(켈트 문화권)의 백파이프. 하이랜드보다 작고 음량도 한 단계 낮으며, 축제 음악의 흥이 몸통이다. 카를로스 누녜스로 대표되는 현대 갈리시아 씬은 백파이프를 록 페스티벌 무대에 올렸다.",
