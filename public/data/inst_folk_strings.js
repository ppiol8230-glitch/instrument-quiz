...
const INST_FOLK_STRINGS = [
...

  {
    ...
    family: "활 현악·민속 피들",
    desc: "노르웨이의 민속 바이올린. 연주하는 4현 아래에 공명현 4~5줄이 숨어 있어, 활을 긋는 순간 건드리지 않은 줄들이 따라 울리며 은빛 잔향이 깔려요. 몸통엔 잉크 문양과 자개 장식.",

    sound: {
      tone: ["영롱함", "애수", "신비", "반짝임"],
      toneDesc: "바이올린 소리 위에 공명현의 은은한 메아리가 항상 겹쳐 있어요. 홀로 켜도 두 명이 연주하는 듯한, 피오르 안개 같은 잔향.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 1,
      weightDesc: "바이올린과 동급(500g 안팎). 케이스째 들어도 가벼워요.",
    ...
    cost: {
      ...
      entryDesc: "국내 유통 없음. 노르웨이 공방·중고 직구 기준이며 수제악기라 하한이 높아요. 바이올린에 공명현을 얹은 개조품으로 입문하는 사람도 있음.",
    ...
    funFacts: [
      "영화 '반지의 제왕' 로한 테마의 그 아련한 현 소리가 하딩펠레예요",
      "노르웨이에서는 결혼식 행렬을 하딩펠레가 이끄는 전통이 있어요",
    ],
  },

  {
    ...
    family: "활 현악·건반 피들",
    desc: "스웨덴의 '건반 달린 바이올린'. 활로 켜되 음정은 왼손 건반(키)이 잡아줘요. 12줄의 공명현이 성당 잔향 같은 울림을 더해요. 음정을 귀로 찾을 자신이 없는 사람에게 열려 있는 거의 유일한 활 현악기.",

    sound: {
      tone: ["영롱함", "부드러움", "신비", "나무 울림"],
      toneDesc: "바이올린보다 어둡고 둥근 음색에, 공명현이 만드는 돌성당 에코가 항상 따라붙어요. 건반의 달칵거림도 매력의 일부.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "줄을 손끝으로 누르지 않고 건반을 눌러요. 굳은살 걱정 제로.",
      embouchure: 0,
      breath: 0,
      weight: 2,
      weightDesc: "약 2kg을 스트랩으로 몸 앞에 메요. 서서도 앉아서도 부담 적음.",
      posture: "기타처럼 몸 앞에 걸치는 자세라 바이올린류 중 목·어깨가 가장 편해요",
      postureRisk: [],
    ...
    caveats: [
      "국내에서 실물 보기조차 어려워요. 구매·수리·레슨 전부 해외 의존",
      "건반이 음정을 잡아줘도 활 컨트롤(발음·강약)은 바이올린만큼 연습이 필요",
      "37개 키 + 16줄 구조라 조율·정비에 손이 가요",
    ],
    funFacts: [
      "옛 스웨덴 50크로나 지폐에 그려져 있던 국민 악기",
      "음정은 건반이 잡아주므로 '활 현악기를 하고 싶은데 음감이 불안한 사람'의 사실상 유일한 루트로 통해요",
    ],
  },

  {
    ...
    aka: ["erhu", "二胡", "이호"],
    family: "활 현악·호궁류",
    desc: "두 줄 사이에 활이 끼워져 있는 중국의 대표 찰현악기. 지판이 없어 허공에서 줄을 짚으며, 사람 목소리에 가장 가깝다는 애절한 음색으로 유명해요.",

    sound: {
      tone: ["애수", "노래하는 듯", "콧소리", "부드러움"],
      toneDesc: "울다가 웃는 듯한, 사람 목소리를 닮은 음색. 비단뱀 가죽 울림통 특유의 콧소리 섞인 비브라토가 심금을 긁어요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "지판 없이 줄만 누르므로 기타보다 부드러워요. 굳은살은 얇게 생기는 정도.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "1kg 미만. 무릎에 올리고 앉아 연주.",
      posture: "의자에 앉아 무릎 위. 목·어깨 압박이 없어 바이올린보다 몸이 편해요",
      postureRisk: [],
    ...
    caveats: [
      "지판이 없어 음정을 100% 귀로 잡아요 — 첫 몇 달은 '고양이 우는 소리' 구간을 각오",
      "두 줄 사이에 활이 끼어 있어 활 방향 전환 감각이 바이올린과 다름(바이올린 경험자도 재적응 필요)",
      "국내 레슨은 서울·화교 커뮤니티 중심으로 드문드문. 중국어권 인강은 매우 풍부",
    ],
    funFacts: [
      "대표곡 '이천영월(二泉映月)'은 시각장애 거리 악사 아빙이 남긴 곡이에요",
      "두 줄만으로 새소리·말 울음까지 흉내 내는 묘사 주법이 발달해 있어요",
    ],
  },

  {
    ...
    aka: ["haegeum", "깡깡이"],
    family: "활 현악·호궁류(국악)",
    desc: "두 줄 사이에 활을 끼워 켜는 한국 전통 찰현악기. 줄을 당기는 힘으로 음정을 만드는 '역안법' 덕에 미분음·농현이 자유롭고, 국악기 중 드물게 국악관현악·퓨전·OST를 넘나드는 만능 멜로디 악기예요.",

    sound: {
      tone: ["애수", "콧소리", "거칢", "노래하는 듯"],
      toneDesc: "코맹맹이 소리라고 놀림받지만 그게 매력. 흐느끼듯 꺾고 떨며 우는 소리는 국악기 중 가장 사람 목소리에 가까워요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "줄을 감아쥐고 당기는 역안법이라 손끝보다 손아귀 힘이 먼저 힘들어요. 굳은살은 가벼움.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "1kg 미만. 무릎에 세워 놓고 앉아 연주.",
      posture: "앉은 자세에 무릎 거치라 몸 부담이 적어요. 왼 손목 사용량은 많은 편",
      postureRisk: ["손목"],
    ...
    cost: {
      ...
      entryDesc: "국악사에서 연습용 해금 구입 가능. 대여 후 구매 루트도 흔해요.",
...

  {
    ...
    aka: ["ajaeng", "산조아쟁", "대아쟁"],
    family: "활 현악·치터류(국악)",
    desc: "눕혀 놓은 커다란 울림통 위 굵은 명주실 줄을 개나리 활대로 문질러 내는 국악 저음 찰현악기. 국악관현악의 첼로 포지션이며, 갈라지는 듯 낮게 우는 소리가 한(恨)의 대명사예요.",

    sound: {
      tone: ["낮고 깊음", "거칢", "애수", "먹먹함"],
      toneDesc: "쓸리고 갈라지는 저음이 바닥을 긁어요. 슬픈 장면 국악 BGM에서 '흐어엉' 하고 우는 그 소리.",
      volume: 4,
      sustain: 3,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 4,
      weightDesc: "몸통이 가야금보다 크고 무거워요. 혼자 들고 다니면 운동 됨.",
      posture: "바닥 양반다리 연주가 기본. 허리·고관절이 뻐근할 수 있어요",
      postureRisk: ["허리"],
      handSize: "제약 거의 없음",
    },
    ...
    cost: {
      ...
      entryDesc: "국악사 주문 제작이 기본. 연습용 산조아쟁 기준이며 대아쟁은 더 비싸요.",
    ...
    caveats: [
      "첫 소리부터 듣기 좋은 악기가 아니에요 — 활 압력 조절이 안 되면 톱질 소리가 한동안 계속됨",
      "레슨은 국악학원·전공자 중심으로 구할 수 있으나 해금·가야금보다는 선생이 적어요",
      "크고 무거워 이동 연주는 차가 사실상 필수",
    ],
    funFacts: [
      "활이 말총이 아니라 개나리 나뭇가지예요. 송진을 발라 나무로 줄을 긁어요",
      "영화·드라마에서 '조선의 슬픔' 장면 저음은 십중팔구 아쟁이에요",
    ],
  },

  {
    ...
    family: "활 현악·호궁류",
    desc: "머리에 말 조각이 새겨진 몽골의 두 줄 찰현악기. 줄과 활이 모두 말총 다발이라 폭신하고 넓은 저음이 나며, 초원의 바람과 말 달리는 리듬을 그대로 옮긴 주법이 특징이에요.",
    ...
    body: {
      saliva: 0,
      callus: 1,
      callusDesc: "손톱 옆면·관절로 줄을 짚는 독특한 운지라 손끝 굳은살은 거의 없어요. 대신 처음엔 짚는 위치가 낯설어요.",
      embouchure: 0,
      breath: 0,
      weight: 2,
    ...
    caveats: [
      "국내 레슨·수리처가 사실상 없어요. 유튜브·몽골 온라인 레슨 의존",
      "손톱 옆면으로 짚는 운지가 다른 현악기 경험과 호환이 낮아 처음엔 다 새로 배우는 기분",
      "말총 줄은 습도에 예민해 장마철 관리가 번거로워요",
    ],
    funFacts: [
      "유네스코 인류무형문화유산. 몽골 가정엔 한 집에 하나씩 있다는 국민 악기",
      "흐미(목 배음 창법)를 얹어 혼자서 노래+반주를 다 하는 전통이 있어요",
    ],
  },

  {
    ...
    family: "활 현악·스파이크 피들",
    desc: "둥근 울림통에 긴 꼬챙이 다리가 달린 페르시아 찰현악기. 무릎 위 꼬챙이를 축으로 악기를 빙글 돌려가며 활을 대는 독특한 주법으로, 미분음이 흐르는 페르시아 라디프 음악의 간판 선율 악기예요.",

    sound: {
      tone: ["애수", "콧소리", "화려함", "노래하는 듯"],
      toneDesc: "바이올린보다 가늘고 건조한, 사막 햇빛 같은 음색. 잘게 떨리는 장식음이 물결처럼 이어져요.",
      volume: 3,
      sustain: 3,
    },
    ...
    caveats: [
      ...
      "즉흥(라디프) 문화 비중이 커서 악보 중심 학습자에겐 낯설어요",
    ],
    funFacts: [
      "연주자가 활을 움직이는 게 아니라 악기를 돌려서 줄을 활에 갖다 대요",
      "카만체 거장 케이한 칼호르는 요요마의 실크로드 앙상블 멤버로 그래미를 받았어요",
    ],
  },

  {
    ...
    aka: ["sarangi", "सारंगी"],
    family: "활 현악·인도 고전",
    desc: "통나무를 깎아 만든 북인도의 찰현악기. 연주현 3줄 아래 35개 안팎의 공명현이 울리며, 손톱 뿌리 옆 살로 줄을 밀어 짚는 주법으로 사람 목소리의 미끄러짐을 그대로 재현해요. '백 가지 색을 가진 악기'라는 뜻.",

    sound: {
      tone: ["애수", "노래하는 듯", "신비", "먹먹함"],
      toneDesc: "흐느끼는 사람 목소리에 가장 가깝다고 평가받는 소리. 공명현의 잔향이 안개처럼 깔리고, 음과 음 사이가 전부 미끄러짐으로 이어져요.",
      volume: 3,
      sustain: 4,
    },
    ...
    body: {
      saliva: 0,
      callus: 5,
      callusDesc: "손끝이 아니라 손톱 뿌리 옆 큐티클로 줄을 밀어요. 이 부위에 굳은살이 앉기까지의 통증이 현악기 전체에서 최상급 — 악기 자체가 통과의례.",
      embouchure: 0,
      breath: 0,
      weight: 2,
    ...
    cost: {
      ...
      midKRW: [1500000, 4000000],
      running: "거트 줄이 잘 끊기고 비싸요. 공명현 35줄 조율은 일상",
    },
    practical: {
      portability: 3,
      noise: 3,
    ...
    caveats: [
      "인도 본토에서도 '가장 배우기 어려운 악기'로 꼽혀요 — 취미 접근은 냉정히 비추천에 가깝고, 그만큼 도전 가치가 있는 악기",
      "큐티클 통증 구간이 몇 달 단위. 손을 쓰는 직업이면 신중히",
      "국내 레슨 전무, 구루(스승) 전통이라 체계적 독학 교재도 드물어요",
    ],
    funFacts: [
      "원래 성악 반주 악기라 '목소리를 따라 우는' 능력이 정체성이에요",
      "공명현까지 40줄에 육박하지만 활이 닿는 줄은 단 3줄이에요",
    ],
  },

  {
    ...
    family: "활 현악·기계식(크랭크)",
    desc: "오른손 크랭크를 돌리면 송진 바른 나무 바퀴가 줄을 끊임없이 문지르고, 왼손 건반이 음정을 잡는 중세 유럽의 기계식 현악기. 백파이프 같은 드론 위에 멜로디가 얹히고, 트롬펫 현이 '지지직' 리듬 버즈를 더해요.",
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "왼손은 건반, 오른손은 크랭크. 굳은살 요소가 없어요.",
      embouchure: 0,
      breath: 0,
      weight: 3,
      weightDesc: "3~4kg을 무릎·스트랩으로 지탱. 오래 서면 어깨가 알려요.",
    ...
    caveats: [
      "악기의 절반은 정비예요 — 솜 감기·송진칠·탄젠트 조정을 못 하면 소리가 안 나요(리드 깎기급 관리 손)",
      "크랭크 회전을 고르게 하는 것 자체가 몇 주짜리 기초 훈련",
      "국내 연주자·레슨 극소수. 유럽 온라인 강좌 의존",
    ],
    funFacts: [
      "중세 성당 음악에서 궁정, 거리 악사까지 천 년을 산 악기예요",
      "게임 '위쳐3' OST와 포크메탈 붐으로 유튜브에서 제2의 전성기를 맞았어요",
    ],
  },
...

  {
    ...
    aka: ["gayageum", "伽倻琴"],
    family: "발현·치터류(국악)",
    desc: "오동나무 울림통 위 12줄(개량형 18·25현)을 안족(기러기발 브리지)으로 받치고 맨손가락으로 뜯고 튕기는 한국 대표 발현악기. 왼손으로 줄을 눌러 흔드는 농현이 소리의 절반이에요.",

    sound: {
      tone: ["나무 울림", "맑음", "소박함", "애수"],
      toneDesc: "손끝 살로 뜯는 둥글고 순한 소리. 왼손 농현이 들어가는 순간 음 하나가 울고 웃어요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 3,
      callusDesc: "맨손가락으로 명주실 줄을 뜯어 오른손 손끝 물집·굳은살 통과 필수. 왼손도 줄을 깊게 눌러 아파요.",
      embouchure: 0,
      breath: 0,
      weight: 3,
    ...
    cost: {
      ...
      entryDesc: "국악사 연습용 기준. 문화센터·국악학원 대여로 시작하는 경우도 많아요.",
    ...
    caveats: [
      ...
      "정악·산조·25현이 사실상 다른 악기 수준으로 갈라져요 — 시작 전 방향을 정할 것",
      "바닥 연주 문화라 입식 스탠드 없이는 의자 생활자에게 낯설어요",
    ],
    funFacts: [
      "가야국 우륵이 만들었다고 삼국사기에 기록된, 이름부터 1500년 된 악기",
      "가야금 병창은 혼자 노래하며 반주까지 하는 국악판 싱어송라이터 전통이에요",
    ],
  },

  {
    ...
    aka: ["geomungo", "玄琴", "현금"],
    family: "발현·치터류(국악)",
    desc: "6줄을 술대(대나무 막대)로 내리치고 뜯는 한국의 저음 발현악기. 줄을 때리는 타격감과 괘(프렛) 위에서 줄을 밀어 올리는 묵직한 농현이 공존해 '선비의 악기'이자 국악기 중 가장 록에 가까운 소리로 통해요.",

    sound: {
      tone: ["낮고 깊음", "타격감", "거칢", "나무 울림"],
      toneDesc: "술대가 줄과 울림통을 '쿵' 때리는 소리까지 음악의 일부. 저음 현을 긁어 올리면 일렉 기타 벤딩 같은 박력이 나요.",
      volume: 4,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 3,
      callusDesc: "오른손은 술대라 편하지만, 왼손이 굵은 줄을 괘에 눌러 밀어 올리느라 손끝·손가락 관절이 단련될 때까지 아파요.",
      embouchure: 0,
      breath: 0,
      weight: 4,
    ...
    cost: {
      entryKRW: [500000, 1500000],
      entryDesc: "국악사 연습용 기준. 가야금보다 수요가 적어 중고 매물도 적어요.",
    ...
    caveats: [
      "술대 타법 + 왼손 밀어짚기의 이중 관문이라 첫 곡까지 가야금보다 오래 걸려요",
      "무겁고 커서 레슨 다닐 때 이동이 진짜 고민거리",
      "가야금보다 배우는 사람이 적어 취미반 개설이 드문 지역이 많아요",
    ],
    funFacts: [
      "고구려 왕산악이 만들었고, 연주하자 검은 학이 날아와 춤춰 '현학금'이 되었다는 전설의 악기",
      "밴드 '잠비나이'가 거문고로 포스트록·메탈을 하며 해외 페스티벌을 돌았어요",
    ],
  },

  {
    ...
    aka: ["koto", "箏", "일본 쟁"],
    family: "발현·치터류(일본)",
    desc: "13줄을 움직이는 브리지(지)로 조율하고, 오른손 세 손가락에 상아·플라스틱 피크(쓰메)를 끼워 뜯는 일본 대표 치터. 일본 정월 BGM '봄의 바다'의 그 소리예요.",

    sound: {
      tone: ["맑음", "영롱함", "우아한", "나무 울림"],
      toneDesc: "피크로 뜯는 또랑또랑한 소리에 왼손 눌러 꺾는 여운이 스며요. 글리산도 한 번이면 즉시 '일본 정원' 공기.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 1,
      callusDesc: "오른손은 피크(쓰메)를 끼워 굳은살 거의 없음. 왼손 눌러짚기(오시데)만 가볍게 아파요.",
      embouchure: 0,
      breath: 0,
      weight: 4,
    ...
    caveats: [
      ...
      "브리지를 세워 조율하는 과정(조현)이 매번 몇 분씩 걸려요",
    ],
    funFacts: [
      "브리지 위치만 옮기면 조가 통째로 바뀌는 구조라 '움직이는 조율' 악기로 불려요",
      "가야금·고쟁과 같은 조상(중국 쟁)에서 갈라진 형제 악기예요",
    ],
  },

  {
    ...
    aka: ["shamisen", "三味線", "산현"],
    family: "발현·류트류(일본)",
    desc: "가죽 울림통에 3줄, 큼직한 은행잎 모양 바치(채)로 줄과 가죽을 동시에 때리는 일본 발현악기. 특히 츠가루 샤미센은 두들기고 긁는 타악적 즉흥 연주로 '일본의 블루스'라 불려요.",

    sound: {
      tone: ["타격감", "카랑카랑", "거칢", "콧소리"],
      toneDesc: "'바칭!' 하고 가죽을 때리는 어택에 사와리(의도된 버즈)가 지지직 얹혀요. 반주 없이도 리듬과 멜로디가 동시에 성립.",
      volume: 4,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "무프렛이지만 줄 장력이 기타보다 부드러워요. 바치 쥔 오른손·손목 피로가 먼저 옴.",
      embouchure: 0,
      breath: 0,
      weight: 2,
    ...
    caveats: [
      "무프렛 3현이라 음정은 귀로 잡아요(포지션 스티커로 입문 가능)",
      "국내 레슨 사실상 전무. 일본 온라인 레슨·유튜브 의존",
      "천연 가죽 악기는 한국 사계절 습도에 취약 — 입문은 합성 가죽 필수",
    ],
    funFacts: [
      "츠가루 샤미센은 눈 내리는 아오모리의 거리 악사들이 밥벌이 경쟁으로 발전시킨 장르예요",
      "요시다 형제가 샤미센으로 록 페스티벌을 뒤집으며 세계에 알렸어요",
    ],
  },

  {
    ...
    aka: ["pipa", "琵琶", "중국 비파"],
    family: "발현·류트류(중국)",
    desc: "배(梨) 모양 몸통을 세워 안고 다섯 손가락에 인조 손톱을 붙여 연주하는 중국 4현 발현악기. 다섯 손가락이 물레방아처럼 도는 트레몰로(룬즈)와 전투 묘사곡의 격렬함으로 '악기의 왕'이라 불려요.",

    sound: {
      tone: ["카랑카랑", "화려함", "타격감", "반짝임"],
      toneDesc: "구슬이 옥쟁반에 쏟아진다고 백거이가 묘사한 그 소리. 트레몰로가 물결처럼 이어지다 현을 비틀어 긁으면 칼싸움 효과음까지 내요.",
      volume: 3,
      sustain: 2,
    },
    ...
    body: {
      ...
      postureRisk: [],
      handSize: "넥 상단 프렛 간격이 넓어 손 작으면 하이 포지션이 처음에 버거워요",
    },
    ...
    caveats: [
      ...
      "한국 전통 비파(당비파·향비파)와는 다른 악기예요 — 국악 비파는 복원 단계라 배우기 더 어려워요",
    ],
    funFacts: [
      "'비'는 밖으로 튕기기, '파'는 안으로 튕기기라는 주법 이름이 그대로 악기 이름이 됐어요",
      "대표곡 '십면매복'은 기원전 해하 전투를 악기 하나로 중계하는 배틀 실황곡이에요",
    ],
  },

  {
    ...
    aka: ["guzheng", "古筝", "구정"],
    family: "발현·치터류(중국)",
    desc: "21줄을 인조 손톱으로 뜯는 중국의 대형 치터. 오른손으로 뜯고 왼손으로 줄을 눌러 음을 휘게 하며, 손끝으로 줄을 쓸어내리는 글리산도 한 번에 '무협 영화' 공기가 만들어져요.",
    ...
    body: {
      saliva: 0,
      callus: 1,
      callusDesc: "인조 손톱(테이프 부착)으로 뜯어 오른손 통증 거의 없음. 왼손 눌러짚기만 가볍게 아파요.",
      embouchure: 0,
      breath: 0,
      weight: 4,
      weightDesc: "길이 1.6m·10kg 안팎. 전용 스탠드 포함 사실상 가구.",
      posture: "의자+스탠드 연주가 표준이라 앉은 자세는 편해요",
      postureRisk: [],
      handSize: "제약 거의 없음",
    },
    ...
    caveats: [
      "펜타토닉 조율이라 시작은 쉽지만, 조 옮기려면 브리지를 다시 세팅해야 해요",
      "악기가 크고 무거워 '어디 둘지'부터 결정하고 살 것",
      "국내 레슨은 중국악기 학원·화교 커뮤니티 중심으로 서울 외 지역은 드묾",
    ],
    funFacts: [
      "뜯자마자 그럴듯한 소리가 나 중국에서 '입문 만족도 1위' 전통악기로 통해요",
      "가야금(12현)·고토(13현)의 원형이 된 중국 쟁이 현대에 21현으로 커진 거예요",
    ],
  },

  {
    ...
    desc: "브리지 없이 7줄을 맨손으로 누르고 쓸며 연주하는 3천 년 역사의 중국 문인 악기. 소리보다 여백, 하모닉스와 슬라이드의 잔향을 듣는 '혼자 마음을 다스리는' 명상적 악기예요.",

    sound: {
      tone: ["낮고 깊음", "먹먹함", "명상적", "나무 울림"],
      toneDesc: "울림통 속으로 잦아드는 낮은 여운, 줄 위를 미끄러지는 손가락 마찰음까지 음악이에요. 세상에서 가장 조용한 현악기급.",
      volume: 1,
      sustain: 4,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "왼손이 줄 위를 누른 채 미끄러지는 주법이라 손끝이 단련될 때까지 쓸리는 통증이 있어요.",
      embouchure: 0,
      breath: 0,
      weight: 3,
    ...
    cost: {
      ...
      entryDesc: "직구 기준. 저가 합판 구친은 잔향이 죽어 악기 구실을 못 한다는 평이 정설 — 입문가 하한이 다른 중국악기보다 높아요.",
    ...
    caveats: [
      "악보가 오선보가 아니라 한자 조합 기보(감자보) — 문자 해독부터 공부예요",
      "무대·합주용이 아니라 자기수양용 악기예요. 남에게 들려주는 게 목적이면 고쟁을 권함",
      "국내 레슨 사실상 전무. 중국어권 인강 의존",
    ],
    funFacts: [
      "유네스코 인류무형문화유산. 공자가 연주했다는 바로 그 악기예요",
      "1977년 보이저 골든 레코드에 실려 구친 곡 '유수(流水)'가 지금 성간 우주를 날고 있어요",
    ],
  },

  {
    ...
    aka: ["oud", "عود", "아우드"],
    family: "발현·류트류(중동)",
    desc: "프렛이 전혀 없는 서양배 모양 몸통의 아랍·터키 발현악기. 리샤(긴 피크)로 낮고 둥근 음을 굴리며, 마캄(아랍 선법)의 미분음을 자유자재로 짚는 중동 음악의 왕. 류트와 기타의 직계 조상이에요.",

    sound: {
      tone: ["낮고 깊음", "따뜻함", "애수", "나무 울림"],
      toneDesc: "프렛 없는 짧은 서스테인의 둥근 저음이 노래하듯 흘러요. 트레몰로와 미분음 장식이 사막 밤공기 같은 정서를 만들어요.",
      volume: 3,
      sustain: 2,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "나일론 줄이라 기타(쇠줄)보다 순해요. 클래식 기타 수준의 적응기.",
      embouchure: 0,
      breath: 0,
      weight: 1,
      weightDesc: "1kg 안팎으로 의외로 가벼워요. 몸통이 둥글어 안는 감각만 낯설어요.",
      posture: "앉아서 안는 자세. 부담 적음",
      postureRisk: [],
      handSize: "넥이 짧고 폭이 넓어요. 손 작아도 가능",
    },
    ...
    caveats: [
      "프렛 제로(F3) — 기타 경험자도 음정을 처음부터 귀로 다시 배워요",
      "코드 반주 악기가 아니라 선율+즉흥(타크심) 악기예요. 노래 반주 목적이면 기타가 나아요",
      "국내 레슨 사실상 전무. 영어·아랍어·터키어권 온라인 강좌는 풍부",
    ],
    funFacts: [
      "유럽으로 건너가 류트(l'oud→lute)가 되었고, 그 후손이 기타예요",
      "아랍 음악에서 '악기의 술탄'으로 불리며 작곡가의 필수 소양 악기예요",
    ],
  },

  {
    ...
    family: "발현·류트류(터키)",
    desc: "물방울 몸통에 긴 넥, 묶어 감은 이동식 프렛이 미분음 자리까지 잡아주는 터키 국민 악기. 얇고 찰랑이는 금속성 스트로크로 노래 반주와 선율을 함께 소화하며, 아나톨리아 음유시인(아식) 전통의 심장이에요.",

    sound: {
      tone: ["금속성", "반짝임", "애수", "카랑카랑"],
      toneDesc: "얇은 쇠줄 코스가 찰랑찰랑 울리는 은빛 소리. 드론 코스를 울리며 멜로디를 얹으면 혼자서도 꽉 차요.",
      volume: 3,
      sustain: 3,
    },
...

  {
    ...
    aka: ["sitar", "सितार"],
    family: "발현·류트류(인도)",
    desc: "호리병박 울림통에 굽은 금속 프렛, 연주현 아래 공명현 10여 줄이 반짝이는 북인도 고전 악기. 줄을 옆으로 끌어당겨 음을 한없이 휘는 '민드'와 웅웅거리는 배음(자와리)이 라가의 우주를 만들어요.",

    sound: {
      tone: ["신비", "몽환", "금속성", "화려함"],
      toneDesc: "웅- 하고 번지는 배음 버즈 위로 음이 미끄러지고 휘어요. 한 음을 뜯어도 공명현이 무지개처럼 따라 울려요.",
      volume: 3,
      sustain: 4,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 3,
      weightDesc: "1.2m·3~4kg. 호리병박 울림통이 깨지기 쉬워 운반이 조심스러워요.",
    ...
    caveats: [
      "곡이 아니라 라가(선법)와 즉흥 체계를 배우는 악기 — 한 곡 뽑기식 목표와는 문법이 달라요",
      "공명현 포함 20줄 조율이 연습 시간의 상당 부분을 먹어요",
      "국내 레슨 극소수(인도문화원 등 간헐적). 영어권 온라인 강좌는 풍부",
    ],
    funFacts: [
      "비틀즈 'Norwegian Wood'의 조지 해리슨이 서구 팝에 시타르를 심었어요",
      "라비 샹카르는 우드스톡과 그래미를 넘나든 최초의 인도 고전 슈퍼스타였어요",
    ],
  },

  {
    ...
    desc: "반으로 가른 큰 박에 가죽을 씌운 울림통에 21줄을 세로로 걸고, 양손 엄지·검지 네 손가락만으로 뜯는 서아프리카의 하프류트. 베이스·반주·멜로디가 동시에 흐르는 소리가 '혼자 치는 하프+기타'예요.",

    sound: {
      tone: ["영롱함", "따뜻함", "그루브", "반짝임"],
      toneDesc: "하프의 맑음과 기타의 리듬감 사이. 물방울 구르듯 순환하는 아르페지오 위에 멜로디가 넘실대요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 2,
      callusDesc: "나일론(낚싯줄) 현을 엄지·검지로 뜯어요. 가벼운 굳은살 수준.",
      embouchure: 0,
      breath: 0,
      weight: 3,
    ...
    caveats: [
      ...
      "국내 연주자·레슨이 손에 꼽혀요. 영어·프랑스어권 온라인 강좌 의존",
      "악보 문화가 아니라 구전·패턴 문화라 귀 카피 학습이 기본",
    ],
    funFacts: [
      "그리오(구전 역사가) 가문이 대대로 세습해 온 이야기꾼의 악기예요",
      "왼손 베이스+오른손 멜로디의 순환 패턴(쿰벵고)은 미니멀 음악처럼 트랜스를 만들어요",
    ],
  },

  {
    ...
    desc: "사다리꼴 상자 위 72줄을 깃털처럼 가벼운 나무채(메즈랍)로 두드리는 페르시아 타현악기. 손끝으로 줄을 누르는 일이 아예 없어 '현악기의 소리, 타악기의 몸'을 가졌어요.",

    sound: {
      tone: ["영롱함", "반짝임", "몽환", "금속성"],
      toneDesc: "빗방울이 유리에 튀듯 잘게 반짝이는 트레몰로. 댐퍼가 없어 모든 음이 은은하게 섞이며 안개 같은 잔향을 만들어요.",
      volume: 3,
      sustain: 4,
    },
    ...
    body: {
      ...
      breath: 0,
      weight: 3,
      weightDesc: "4~5kg + 스탠드. 자주 옮길 악기는 아니에요.",
    ...
    caveats: [
      ...
      "페르시아 음계(미분음) 조율 체계를 익혀야 본토 레퍼토리가 열려요",
      "국내 레슨 전무. 이란·인도계 온라인 강좌 의존",
    ],
    funFacts: [
      "피아노의 먼 조상 — 줄을 해머로 때리는 발상이 여기서 건반악기로 이어졌어요",
      "인도의 산투르(카슈미르)는 같은 이름의 사촌으로, 라가 연주용으로 개량됐어요",
    ],
  },

  {
    ...
    family: "타현·해머드 덜시머류",
    desc: "사다리꼴 몸통에 펼쳐진 수십 코스의 줄을 양손의 작은 나무 해머로 두드리는 타현악기. 줄을 손으로 누르지 않으니 손끝이 하나도 안 아픈, '현악기 소리를 갖고 싶지만 굳은살은 싫은' 사람의 정답 카드예요.",

    sound: {
      tone: ["영롱함", "반짝임", "맑음", "나무 울림"],
      toneDesc: "오르골을 크게 확대한 듯한 반짝임. 두드린 음들이 서로 섞이며 벨소리 같은 잔향 구름을 만들어요.",
      volume: 4,
      sustain: 4,
    },
    ...
    body: {
      saliva: 0,
      callus: 0,
      callusDesc: "해머만 쥐어요. 굳은살·물집 개념 자체가 없어요 — 손끝 통증 때문에 기타를 포기한 사람의 대표 우회로.",
      embouchure: 0,
      breath: 0,
      weight: 4,
      weightDesc: "7~10kg + 전용 스탠드. 집 붙박이형에 가까워요.",
    ...
    cost: {
      ...
      entryDesc: "국내 유통 없음. 미국(더스티 스트링스 등)·유럽 직구 기준이며 부피 탓에 배송비가 상당해요.",
    ...
    practical: {
      portability: 2,
      noise: 4,
      apartmentOk: "음량이 크고 잔향이 길어요. 낮 시간·약음 펠트 권장",
      selfLearn: 3,
      lessonKR: 1,
      entryBarrier: 2,
      quickReward: 4,
    ...
    caveats: [
      "줄이 수십 개라 '어느 줄이 어느 음인지' 줄 지도를 외우는 게 초반 최대 과제 — 배열이 5도 간격 지그재그라 처음엔 미로 같아요",
      "조율기는 필수품 — 수십 줄을 주기적으로 잡아야 해요",
      "크고 무거워 '두는 악기'예요. 세션에 들고 다니는 건 각오가 필요",
    ],
    funFacts: [
      "피아노의 직계 조상 중 하나 — 줄을 해머로 친다는 아이디어가 그대로 건반화됐어요",
      "미국 올드타임과 아이리시, 중동 산투르, 헝가리 침발롬이 모두 한 가족이에요",
    ],
  },

  {
    ...
    desc: "다리 4개와 댐퍼 페달까지 갖춘 '그랜드피아노급 해머드 덜시머'. 솜 감은 채로 저음 줄을 두드리면 몽환적인 트레몰로가 홀을 채우고, 집시 밴드와 클래식 오케스트라를 오가는 헝가리의 자존심이에요.",
    ...
    caveats: [
      "악기 확보 자체가 프로젝트예요 — 국내 중고 시장이 없어 유럽 직구+국제 운송을 감당해야 함",
      "놓을 공간과 옮길 인력(2인 이상)이 상시 문제",
      "국내 연주자가 극소수라 레슨은 해외 온라인 의존",
    ],
    funFacts: [
      "코다이 '하리 야노시'와 영화 '셜록 홈즈' OST의 신비한 트레몰로가 침발롬이에요",
      "헝가리 카페 문화에서는 집시 밴드의 침발롬이 오늘날의 DJ 포지션이었어요",
    ],
  },

  {
    ...
    family: "발현·라멜로폰(음판)",
    desc: "나무 몸통 위 금속 음판을 양손 엄지로 튕기는 아프리카 유래의 '엄지 피아노'. 오르골 소리를 내 손으로 만드는 감각으로, 사자마자 그날 한 곡이 되는 즉각 보상의 왕이에요.",

    sound: {
      tone: ["영롱함", "맑음", "따뜻함", "귀여운"],
      toneDesc: "오르골과 물방울 사이의 동글동글한 소리. 음 하나하나가 예뻐서 대충 튕겨도 힐링 ASMR이 돼요.",
      volume: 2,
      sustain: 3,
    },
    ...
    body: {
      saliva: 0,
      callus: 1,
      callusDesc: "엄지 손톱·살로 튕겨 처음엔 엄지 끝이 얼얼하지만 굳은살 단계까지는 안 가요.",
      embouchure: 0,
      breath: 0,
      weight: 1,
    ...
    caveats: [
      ...
      "너무 쉬워서 금방 정체기 — '더 배울 것'을 찾는 사람에겐 심심해질 수 있어요",
