...
const INST_FOLK_STRINGS = [
...

  {
    ...
    aka: ["sarangi", "सारंगी"],
    family: "활 현악·인도 고전",
    desc: "통나무를 깎아 만든 북인도의 찰현악기. 연주현 3줄 아래 35여 개의 공명현이 울리며, 손톱 뿌리 옆 살로 줄을 밀어 짚는 주법으로 사람 목소리의 미끄러짐을 그대로 재현한다. '백 가지 색을 가진 악기'라는 뜻.",
...

  {
    ...
    desc: "반 갈라 가죽을 씌운 큰 박 울림통에 21줄을 세로로 걸고, 양손 엄지·검지 네 손가락만으로 뜯는 서아프리카의 하프류트. 베이스·반주·멜로디가 동시에 흐르는 소리가 '혼자 치는 하프+기타'다.",
...

  {
    ...
    caveats: [
      "배음렬 배치의 줄 지도(어느 코스가 어느 음인지)를 외우는 게 초반 최대 과제",
