...
const INST_WOODWIND_WESTERN = [
...

  {
    ...
    family: "목관·에어리드(플루트족)",
    desc: "입에 물기만 하면 소리가 나는 휘슬형 목관. 한국에선 '초등학교 준비물'이라는 편견이 강하지만, 원래는 바흐·헨델·텔레만이 독주 협주곡을 써준 바로크의 정식 독주 악기예요. 성인이 되어 나무 리코더로 바로크 소나타를 다시 만나면 완전히 다른 악기가 돼요 — 세계적으로는 이 '재평가 루트'로 입문하는 성인 아마추어가 상당히 많아요.",

    sound: {
      tone: ["맑음", "소박함", "나무 울림", "숨소리 섞임"],
      toneDesc: "맑고 순한 피리 소리. 플라스틱은 다소 밋밋하지만, 나무 리코더는 숨결이 섞인 따뜻하고 고풍스러운 음색이 나요. 알토·테너·베이스로 내려갈수록 부드럽고 그윽해져요.",
      volume: 2,
      sustain: 3,
    },
    ...
    tracks: [
      { id: "baroque", label: "바로크 정통(알토 리코더)", genres: ["바로크·고음악"], note: "성인 재입문의 정석. F조 알토로 헨델·텔레만 소나타. 바로크 운지·장식음을 새로 배워요." },
      { id: "casual", label: "입문·앙상블", genres: ["포크", "클래식"], note: "소프라노/테너로 아는 멜로디부터. 리코더 콘소트에 들어가면 4성부 합주의 재미가 커요." },
    ],
    ...
    funFacts: ["바흐 브란덴부르크 협주곡 2·4번의 '플루트' 파트는 원래 리코더예요", "비발디는 리코더 협주곡을 20곡 넘게 썼어요"],
  },

  {
    ...
    family: "목관·에어리드(플루트족)",
    desc: "은빛 관을 옆으로 들고 입김의 각도로 소리를 만드는 대표 목관. 리드가 없어 소모품 걱정이 없고, 오케스트라부터 재즈·OST까지 레퍼토리가 넓어요. 첫 소리(암부슈어) 관문만 넘으면 이후 성장 곡선이 완만한, 취미 목관의 표준 선택지.",

    sound: {
      tone: ["맑음", "영롱함", "부드러움", "숨소리 섞임"],
      toneDesc: "맑고 투명한 고음. 저음역은 의외로 어둡고 관능적이며, 숨소리를 섞은 재즈 톤·휘파람 같은 순음까지 표정이 다양해요.",
      volume: 3,
      sustain: 3,
    },
    ...
    body: {
      ...
      breath: 2,
      weight: 1,
      weightDesc: "약 450g. 케이스째 들어도 가벼워요.",
    ...
    tracks: [
      ...
      { id: "jazz", label: "재즈", genres: ["재즈"], note: "허비 만 계열의 플루트 재즈. 숨소리·허밍을 섞는 특유의 주법. 색소폰 겸업 주자도 많아요." },
    ...
    funFacts: ["금·은으로 만들어도 분류는 '목관' — 리드 없이 에어리드로 소리 내기 때문", "표준 보임 시스템은 1847년 완성 이후 거의 그대로예요"],
  },

  {
    ...
    aka: ["piccolo"],
    family: "목관·에어리드(플루트족)",
    desc: "플루트의 절반 크기, 한 옥타브 위. 오케스트라 전체를 뚫고 맨 꼭대기에서 반짝이는 최고음 담당이에요. 보통 플루트를 먼저 배운 뒤 겸하는 '세컨드 악기'이며, 취주악·오케스트라에서 수요가 꾸준해요. 단독 입문 악기로는 비추천이지만 플루트 주자의 확장으로는 최고의 가성비 포지션.",

    sound: {
      tone: ["카랑카랑", "반짝임", "화려함", "금속성"],
      toneDesc: "새소리처럼 높고 찌르는 광휘. 잘 불면 오케스트라 위에 뿌려지는 별가루, 못 불면 그냥 비명이에요. 저음역은 의외로 여리고 귀여워요.",
      volume: 5,
      sustain: 3,
    },
    ...
    caveats: [
      ...
      "고음 연습은 본인 귀도 괴로움(귀마개 끼고 연습하는 주자가 많아요)",
      "독주 레퍼토리가 얇아 혼자 놀기보다 합주용 포지션",
    ],
    funFacts: ["수자 행진곡 '성조기여 영원하라'의 피콜로 오블리가토는 취주악 최고의 하이라이트 순간이에요"],
  },

  {
    ...
    family: "목관·에어리드(플루트족)",
    desc: "키가 거의 없는 6홀 나무(또는 폴리머) 플루트. 모던 플루트가 버린 19세기 심플 시스템 설계를 아이리시 음악이 살려 쓰는 악기예요. 은빛 플루트보다 어둡고 숨이 많이 섞인 소리로 릴·지그를 달리며, 틴휘슬과 운지가 같아 아이리시 세션 세계의 표준 승급 코스이기도 해요.",

    sound: {
      tone: ["나무 울림", "숨소리 섞임", "따뜻함", "먹먹함"],
      toneDesc: "허스키하고 어두운 나무 소리. 모던 플루트의 '맑음'과 정반대의 매력 — 숨소리와 타음(태핑)이 섞인 흙내 나는 톤이 아이리시 댄스곡과 맞물려요.",
      volume: 3,
      sustain: 3,
    },
    ...
    funFacts: ["19세기 은플루트가 유행하자 헐값에 풀린 나무 플루트를 아일랜드 악사들이 주워 쓰면서 전통이 됐다는 설이 유력해요"],
  },

  {
    ...
    aka: ["clarinet"],
    family: "목관·싱글리드",
    desc: "싱글 리드 특유의 부드럽고 둥근 소리에, 목관 중 최대급 음역(약 4옥타브)을 가진 만능 악기. 클래식 오케스트라의 주역이면서 스윙 재즈의 원조 스타였고, 클레즈머에선 울고 웃는 사람 목소리가 돼요. 입문 가격이 합리적이고 레슨 인프라도 탄탄해 성인 취미 목관의 가성비 강자.",

    sound: {
      tone: ["부드러움", "따뜻함", "낮고 깊음", "노래하는 듯"],
      toneDesc: "저음(샬뤼모 음역)은 어둡고 벨벳 같으며, 고음은 맑고 반짝여요. 한 악기 안에 첼로와 플루트가 같이 사는 느낌. 클레즈머식으로 꺾으면 웃음·울음소리까지 내요.",
      volume: 3,
      sustain: 3,
    },
    ...
    practical: {
      portability: 4,
      noise: 4,
      apartmentOk: "낮에도 민원 가능권. 이토록 부드러운 소리도 벽 너머에선 '삑삑'이에요. 연습실 병행 권장.",
      selfLearn: 3,
      lessonKR: 4,
      entryBarrier: 3,
      quickReward: 3,
    ...
    funFacts: ["'클라리넷'은 '작은 트럼펫(clarino)'이라는 뜻 — 초기엔 트럼펫 대용 고음 악기였어요", "거슈윈 '랩소디 인 블루' 도입부의 글리산도는 리허설 중 주자의 장난에서 나왔어요"],
  },

  {
    ...
    aka: ["oboe"],
    family: "목관·더블리드",
    desc: "두 장의 얇은 리드를 맞물려 부는 더블리드 목관의 대표. 오케스트라 전체가 이 악기의 A음에 튜닝을 맞추고, 애수 어린 솔로(백조의 호수, 가브리엘의 오보에)를 도맡아요. 소리의 존재감은 목관 최강급이지만, '리드 손질'이라는 평생 과업이 따라오는 장인형 악기.",

    sound: {
      tone: ["애수", "콧소리", "화려함", "노래하는 듯"],
      toneDesc: "갈대 콧소리가 섞인 애절하고 또렷한 음색. 오케스트라 어디서든 뚫고 나오는 존재감이 있어 '목관의 프리마돈나'로 불려요.",
      volume: 3,
      sustain: 4,
    },
    ...
    cost: {
      ...
      running: "리드가 최대 지출 — 완제품 개당 1.5~3만원, 수명 2~4주. 월 3~6만원. 상급자는 결국 직접 깎아요(도구 세트 수십만원).",
    },
    practical: {
      portability: 5,
      noise: 4,
    ...
    funFacts: ["오케스트라 튜닝의 기준 A음을 오보에가 부는 건 음색이 또렷하고 음정이 잘 안 흔들리기 때문", "엔니오 모리코네 '가브리엘의 오보에'는 이 악기 최고의 영업 사원이에요"],
  },

  {
    ...
    family: "목관·더블리드",
    desc: "오보에보다 5도 낮은 알토 오보에. 서양배 모양 벨에서 나오는 어둡고 목가적인 소리로, 드보르자크 신세계 교향곡 2악장 '꿈속의 고향' 솔로가 이 악기예요. 단독 입문 악기가 아니라 오보에 주자가 겸하는 세컨드 악기이며, 그 조건만 맞으면 오케스트라에서 가장 아름다운 솔로들이 기다려요.",

    sound: {
      tone: ["애수", "낮고 깊음", "먹먹함", "따뜻함"],
      toneDesc: "오보에의 애수를 한 톤 어둡게 가라앉힌 목가적 음색. 노을·향수·기도 같은 장면의 단골로, 오케스트라에서 이 악기가 일어나면 청중이 조용해져요.",
      volume: 3,
      sustain: 4,
    },
    ...
    funFacts: ["드보르자크 신세계 2악장, 로드리고 아랑후에스 협주곡 2악장 — '울리는 명솔로'는 이 악기 몫이 많아요"],
  },

  {
    ...
    family: "목관·더블리드",
    desc: "2.5m 관을 반으로 접은 목관의 저음 기둥. 익살(마법사의 제자)과 비탄(봄의 제전 도입부)을 오가는 표정 부자예요. 악기가 비싸고 배우는 사람이 적다는 게 오히려 기회 — 아마추어 오케스트라마다 바순 자리는 늘 비어 있어서, 중급만 돼도 여기저기서 모셔 가는 '희소 포지션의 왕'이에요.",

    sound: {
      tone: ["낮고 깊음", "나무 울림", "콧소리", "소박함"],
      toneDesc: "마른 나무의 저음. 저역은 든든하고 구수하며, 테너 음역으로 올라가면 사람 목소리 같은 애절함이 나와요. 스타카토는 목관 최고의 코믹 연기.",
      volume: 3,
      sustain: 4,
    },
    ...
    funFacts: ["아마추어 오케스트라 모집 공고에서 '바순 상시 모집'은 거의 관용구예요", "이탈리아어 이름 파고토(fagotto)는 '장작단'이라는 뜻"],
  },

  {
    ...
    desc: "금속 몸통에 클라리넷식 싱글 리드를 단, 1840년대 발명품. 소리 내기가 목관 중 가장 쉽고 소리는 가장 '사람답게' 노래해요. 재즈의 상징이자, 한국에선 중장년 취미 시장의 실세 — 동네마다 색소폰 학원과 동호회가 있고 트로트·가요 반주 문화가 탄탄해요. 유일한 적은 데시벨: 그래서 디지털 색소폰이라는 우회로까지 완비돼 있어요.",

    sound: {
      tone: ["노래하는 듯", "따뜻함", "화려함", "빵빵함"],
      toneDesc: "사람 목소리에 가장 가까운 관악기 소리. 서브톤으로 속삭이는 발라드부터 벨팅하듯 내지르는 솔로까지, 표현 폭이 넓고 직관적이에요. 알토는 화사하고 테너는 굵고 허스키해요.",
      volume: 4,
      sustain: 4,
    },
    ...
    practical: {
      portability: 3,
      noise: 5,
      apartmentOk: "집 연습 불가 수준의 음량. 연습실·차량 연습·야외가 기본이고, 그래서 디지털 색소폰 변형이 흥해요.",
      selfLearn: 4,
      lessonKR: 5,
      entryBarrier: 2,
      quickReward: 5,
    ...
    tracks: [
      { id: "jazz", label: "재즈", genres: ["재즈"], note: "찰리 파커·콜트레인의 계보. 즉흥연주(애드리브)가 본체라 스케일·이론 공부가 따라와요." },
      { id: "pop", label: "팝·버스킹", genres: ["팝·싱어송라이터", "힙합·R&B"], note: "MR 틀고 멜로디를 노래하는 실용 루트. 케니 지 스타일 발라드 포함, 첫 무대가 가장 빠른 트랙." },
      { id: "trot", label: "트로트·가요", genres: ["트로트·가요"], note: "한국 중장년 취미의 주류. 동호회·색소폰 카페·행사 무대 인프라가 전국구로 깔려 있어요." },
      { id: "classical", label: "클래식", genres: ["클래식"], note: "비브라토를 절제한 정통 주법. 콘서트 레퍼토리와 색소폰 콰르텟 문화가 따로 있어요." },
    ],
    ...
    funFacts: ["발명가 아돌프 색스는 특허 분쟁과 암살 시도(!)에 시달리다 파산했어요", "한국 색소폰 동호인 수는 수십만 명대로 추산 — 관악기 중 압도적 1위 취미 시장이에요"],
  },
...

  {
    ...
    desc: "키가 하나뿐인 원뿔형 나무 플루트 — 바흐·텔레만 시대의 '그 플루트'예요. 모던 플루트의 균질한 광택 대신, 조성마다 색이 달라지는 불균질함 자체가 표현 수단이 돼요. 시대연주(HIP) 붐 덕에 아마추어 층도 세계적으로 성장 중이며, 플라스틱 복제품 덕분에 입문 문턱이 의외로 낮아요.",

    sound: {
      tone: ["따뜻함", "나무 울림", "숨소리 섞임", "소박함"],
      toneDesc: "모던 플루트보다 작고 어둡고 사람 숨에 가까운 소리. 포크 운지(교차 운지)로 내는 반음들이 각기 다른 음색을 내는 게 단점이 아니라 바로크 수사학의 재료예요.",
      volume: 2,
      sustain: 3,
    },
    ...
    funFacts: ["바흐 시대 악보의 'flauto'는 리코더, 'flauto traverso'가 이 악기예요", "프리드리히 대왕이 국사 중에도 놓지 않았던 악기로 유명해요"],
  },

  {
    ...
    family: "고악기·더블리드",
    desc: "키가 2~3개뿐인 회양목 오보에. 모던 오보에보다 넓은 리드로 불어 소리가 부드럽고 호흡은 후해요. 바흐 칸타타의 그 애절한 오블리가토들이 전부 이 악기 몫 — 고음악 앙상블에서 리코더·트라베르소와 함께 수요가 꾸준한 선율 악기예요. 모던 오보에 주자의 전향 루트가 정석이지만, 유럽에선 직입문도 드물지 않아요.",

    sound: {
      tone: ["애수", "따뜻함", "콧소리", "나무 울림"],
      toneDesc: "모던 오보에의 레이저 같은 초점을 풀어낸, 둥글고 목가적인 갈대 소리. 사람 목소리와 가장 잘 섞이는 바로크 악기로 꼽혀요.",
      volume: 3,
      sustain: 4,
    },
    ...
    funFacts: ["바흐가 오블리가토 악기로 가장 사랑한 관악기 — 칸타타에 수백 곡 분량의 솔로를 남겼어요"],
  },

  {
    ...
    family: "고악기·더블리드",
    desc: "통나무 하나에 관을 두 번 접어 판, 바순의 직계 조상(르네상스~초기 바로크). 바순보다 구조가 단순하고 소리는 더 거칠고 구수해요. 몬테베르디 시대 종교음악과 스페인 성당 음악의 베이스 기둥으로, 고음악 앙상블에서 '저음 관악'이라는 희소 포지션을 차지해요.",

    sound: {
      tone: ["낮고 깊음", "나무 울림", "거칢", "소박함"],
      toneDesc: "바순보다 원시적이고 버즈(갈대 떨림의 잡맛)가 살아 있는 저음. 감바·사크부트와 섞이면 르네상스 특유의 오르간 같은 혼성 저역이 만들어져요.",
      volume: 3,
      sustain: 4,
    },
    ...
    funFacts: ["이름은 '달콤하다(dulcis)'에서 — 당시 다른 저음 관악(숌 계열)보다 부드럽다고 붙은 이름이에요"],
  },

  {
    ...
    aka: ["chalumeau", "샬뤼모"],
    family: "고악기·싱글리드",
    desc: "리코더 몸통에 싱글 리드를 단 클라리넷의 직계 조상(17세기 말). 음역은 한 옥타브 남짓뿐이지만 그 안의 소리는 클라리넷 저음역(그래서 그 음역 이름이 '샬뤼모 음역'이에요)의 어둡고 벨벳 같은 음색 그 자체. 비발디·텔레만이 협주곡을 남겼고, 리코더 운지와 거의 같아 리코더 인구의 숨은 확장 카드예요.",

    sound: {
      tone: ["낮고 깊음", "부드러움", "따뜻함", "먹먹함"],
      toneDesc: "클라리넷 저음역의 어두운 벨벳 톤만 뽑아낸 소리. 촛불 같은 음량으로, 실내악에서 사람 목소리·리코더와 아름답게 섞여요.",
      volume: 2,
      sustain: 3,
    },
    ...
    funFacts: ["클라리넷 저음역을 지금도 '샬뤼모 음역'이라 불러요 — 악기는 잊혀도 이름은 살아남았어요", "비발디의 챨루모 협주곡들은 베네치아 여자 고아원 오케스트라를 위해 쓰였어요"],
  },

  {
    ...
    aka: ["shawm", "쇼움", "르네상스 숌"],
    family: "고악기·더블리드",
    desc: "오보에의 야생 조상. 피루엣(입술 받침대)에 입을 대고 큰 더블리드를 통째로 울리는, 중세·르네상스의 야외 행사용 확성기예요. 소리는 문자 그대로 나팔급 — 실내 취미가 아니라 축제·행렬·야외 앙상블('라우드 밴드')의 악기이며, 중동 주르나·한국 태평소와 같은 계열의 세계 공통 '야외 리드 나팔' 문화권에 속해요.",
    ...
    practical: {
      portability: 4,
      noise: 5,
      apartmentOk: "실내 연습 불가. 야외·방음 연습실 전제의 악기예요.",
      selfLearn: 2,
      lessonKR: 1,
      entryBarrier: 4,
      quickReward: 3,
    ...
    funFacts: ["중세 유럽 도시들은 숌 악사를 '시청 소속 공무원 밴드'로 고용했어요(독일 슈타트파이퍼)", "태평소·주르나·숌은 실크로드로 이어진 같은 조상의 후손들이에요"],
  },

  {
    ...
    family: "고악기·더블리드(윈드캡)",
    desc: "끝이 우산 손잡이처럼 구부러진 르네상스 관악. 리드가 나무 캡 속에 들어 있어 입술이 리드에 닿지 않아요(윈드캡) — 그래서 더블리드인데도 암부슈어 부담이 거의 없고, 대신 누구나 같은 '붕붕대는 콧소리'가 나요. 음역 9도의 한계 안에서 SATB 콘소트로 모여 노는, 유머와 학구가 공존하는 컬트 악기.",

    sound: {
      tone: ["콧소리", "거칢", "소박함", "그루브"],
      toneDesc: "카주와 백파이프 사이 어딘가의 붕붕대는 버즈 톤. 혼자 들으면 웃기고, 4대가 화음을 쌓으면 뜻밖에 근사한 르네상스 오르간이 돼요.",
      volume: 3,
      sustain: 4,
    },
    ...
    funFacts: ["헨리 8세의 악기 컬렉션 목록에 크룸호른이 수십 대 있었어요", "이름은 독일어로 그냥 '굽은 뿔(Krumm+Horn)'이라는 뜻"],
  },

  {
    ...
    desc: "가죽을 감은 팔각 나무 몸통에 손가락 구멍이 뚫려 있는데, 소리는 초소형 금관 마우스피스에 입술을 대고 버징으로 내요 — 목관과 금관의 하이브리드. 르네상스~초기 바로크에서 '사람 목소리에 가장 가까운 악기'로 최고 대우를 받았고(몬테베르디 베스프로의 주역), 지금도 시대연주계에서 가장 어렵고 가장 귀한 악기로 꼽혀요.",

    sound: {
      tone: ["노래하는 듯", "맑음", "화려함", "숨소리 섞임"],
      toneDesc: "트럼펫의 광채를 사람 목소리의 부드러움으로 감싼 소리. 소프라노 성악과 나란히 놓으면 어느 쪽이 사람인지 헷갈린다는 말이 르네상스 시대부터 있었어요.",
      volume: 3,
      sustain: 4,
    },
    ...
    play: {
      pitchFixed: "F2",
      pitchDesc: "구멍(운지)이 있지만 실제 음은 금관식 입술 버징으로 만들어, 같은 운지에서도 입술로 음이 크게 움직여요. 사실상 F2~F3급 — 음 하나하나를 귀로 조준해야 하며, 요구 음감은 이 DB 관악기 중 최상급.",
      fastPlay: 4,
      chordal: false,
      melodic: true,
      singAlong: false,
    ...
    funFacts: ["17세기 문헌은 명 코르네토 주자의 소리를 '한 줄기 햇살 같은 소리'라 기록했어요", "바흐도 칸타타에서 합창 소프라노 보강용으로 코르네토를 썼어요"],
  },

  {
    ...
    family: "고악기·백파이프(풀무식)",
    desc: "베르사유 귀족들이 '세련된 전원 취미'로 연주하던 실내용 미니 백파이프. 입으로 불지 않고 팔꿈치 풀무로 바람을 넣기 때문에 침도, 폐활량도, 암부슈어도 전혀 필요 없어요 — 관악기의 신체 게이트를 전부 우회하는 유일한 존재. 비단과 상아로 치장한 외관과 여린 드론 소리까지, 고악기 중에서도 가장 귀족적이고 가장 희귀한 선택지예요.",

    sound: {
      tone: ["콧소리", "몽환", "우아한", "소박함"],
      toneDesc: "일반 백파이프의 축소판 같은 여리고 달콤한 갈대 소리 + 낮게 깔리는 드론. 실내에서 쳄발로·비올과 섞이도록 설계된, '실내악 볼륨의 백파이프'예요.",
      volume: 2,
      sustain: 5,
    },
    ...
    caveats: [
      ...
      "레퍼토리가 프랑스 바로크(오트테르, 셰드빌)로 좁고 깊음 — 이 세계가 좋아야 버텨요",
      "가격·대기·수리 전부 유럽 공방 의존이라 유지 리스크가 큼",
    ],
    funFacts: ["비발디 '사계' 봄의 원조 편곡 중 하나가 뮈제트용이었을 만큼 18세기 프랑스에서 유행했어요", "루이 15세 궁정에서는 귀부인의 '전원 코스프레' 필수 소품이었어요 — 비단 드레스에 어울리게 백도 비단으로 쌌어요"],
  },
